(ns cljs-thread.eve
  ...
  (:require
   ...
   [cljs-thread.eve.map :as eve-map]  ;; registers direct-map-encoder
   [cljs-thread.eve.vec]              ;; registers vector builder
   [cljs-thread.eve.set :as eve-set]  ;; registers set builder
   [cljs-thread.eve.list]             ;; registers list builder
