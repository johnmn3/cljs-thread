...
var temp__5823__auto___27131 = new cljs.core.Keyword(null,"loadable-modules","loadable-modules",-582233975).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(cljs_thread.state.conf));
if(cljs.core.truth_(temp__5823__auto___27131)){
var modules_27132 = temp__5823__auto___27131;
var seq__27080_27133 = cljs.core.seq(modules_27132);
var chunk__27081_27134 = null;
var count__27082_27135 = (0);
var i__27083_27136 = (0);
while(true){
if((i__27083_27136 < count__27082_27135)){
var url_27139 = chunk__27081_27134.cljs$core$IIndexed$_nth$arity$2(null, i__27083_27136);
try{cljs_thread.in$.load_module_BANG_(url_27139);
}catch (e27086){var e_27140 = e27086;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"warn","warn",-436710552),new cljs.core.Keyword(null,"failed-to-load-module","failed-to-load-module",-1009352923),url_27139,e_27140], 0));
}

var G__27141 = seq__27080_27133;
var G__27142 = chunk__27081_27134;
var G__27143 = count__27082_27135;
var G__27144 = (i__27083_27136 + (1));
seq__27080_27133 = G__27141;
chunk__27081_27134 = G__27142;
count__27082_27135 = G__27143;
i__27083_27136 = G__27144;
continue;
} else {
var temp__5823__auto___27145__$1 = cljs.core.seq(seq__27080_27133);
if(temp__5823__auto___27145__$1){
var seq__27080_27146__$1 = temp__5823__auto___27145__$1;
if(cljs.core.chunked_seq_QMARK_(seq__27080_27146__$1)){
var c__5568__auto___27147 = cljs.core.chunk_first(seq__27080_27146__$1);
var G__27150 = cljs.core.chunk_rest(seq__27080_27146__$1);
var G__27151 = c__5568__auto___27147;
var G__27152 = cljs.core.count(c__5568__auto___27147);
var G__27153 = (0);
seq__27080_27133 = G__27150;
chunk__27081_27134 = G__27151;
count__27082_27135 = G__27152;
i__27083_27136 = G__27153;
continue;
} else {
var url_27154 = cljs.core.first(seq__27080_27146__$1);
try{cljs_thread.in$.load_module_BANG_(url_27154);
}catch (e27087){var e_27155 = e27087;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"warn","warn",-436710552),new cljs.core.Keyword(null,"failed-to-load-module","failed-to-load-module",-1009352923),url_27154,e_27155], 0));
}

var G__27156 = cljs.core.next(seq__27080_27146__$1);
var G__27157 = null;
var G__27158 = (0);
var G__27159 = (0);
seq__27080_27133 = G__27156;
chunk__27081_27134 = G__27157;
count__27082_27135 = G__27158;
i__27083_27136 = G__27159;
continue;
}
} else {
}
...
var aliases = [];
var n__5636__auto___27164 = params.length;
var i_27165 = (0);
while(true){
if((i_27165 < n__5636__auto___27164)){
var p_27166 = (params[i_27165]).trim();
var sm_27167 = cljs_thread.in$.shadow_param_re.exec(p_27166);
if(cljs.core.truth_(sm_27167)){
aliases.push([cljs.core.str.cljs$core$IFn$_invoke$arity$1((sm_27167[(1)])),"=",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p_27166)].join(''));
} else {
}

var G__27169 = (i_27165 + (1));
i_27165 = G__27169;
continue;
} else {
}
...
var fexpr__27092 = eval(["(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sfn__$2),")();"].join(''));
return (fexpr__27092.cljs$core$IFn$_invoke$arity$5 ? fexpr__27092.cljs$core$IFn$_invoke$arity$5(in_id,direct_sync_QMARK_,sync_signal_sab,sync_atom_id,sync_atom_idx) : fexpr__27092.call(null, in_id,direct_sync_QMARK_,sync_signal_sab,sync_atom_id,sync_atom_idx));
} else {
...
})())?(function (){var fexpr__27093 = eval(["(function () {return (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sfn__$2),");})();"].join(''));
return (fexpr__27093.cljs$core$IFn$_invoke$arity$5 ? fexpr__27093.cljs$core$IFn$_invoke$arity$5(in_id,direct_sync_QMARK_,sync_signal_sab,sync_atom_id,sync_atom_idx) : fexpr__27093.call(null, in_id,direct_sync_QMARK_,sync_signal_sab,sync_atom_id,sync_atom_idx));
 ...
 */
cljs_thread.in$.reconstruct_sync_channel = (function cljs_thread$in$reconstruct_sync_channel(p__27094){
var map__27095 = p__27094;
var map__27095__$1 = cljs.core.__destructure_map(map__27095);
var sync_signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27095__$1,new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526));
var sync_atom_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27095__$1,new cljs.core.Keyword(null,"sync-atom-id","sync-atom-id",-1919513778));
var sync_atom_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27095__$1,new cljs.core.Keyword(null,"sync-atom-idx","sync-atom-idx",526705995));
var in_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27095__$1,new cljs.core.Keyword(null,"in-id","in-id",2013544614));
 ...
 */
cljs_thread.in$.send_result_BANG_ = (function cljs_thread$in$send_result_BANG_(p__27096,result,opts,error_sent_QMARK_){
var map__27097 = p__27096;
var map__27097__$1 = cljs.core.__destructure_map(map__27097);
var data = map__27097__$1;
var direct_sync_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27097__$1,new cljs.core.Keyword(null,"direct-sync?","direct-sync?",-1145947346));
var sync_signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27097__$1,new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526));
var in_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27097__$1,new cljs.core.Keyword(null,"in-id","in-id",2013544614));
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27097__$1,new cljs.core.Keyword(null,"from","from",1815293044));
...
cljs_thread.in$.do_call = (function cljs_thread$in$do_call(p__27103){
var map__27104 = p__27103;
var map__27104__$1 = cljs.core.__destructure_map(map__27104);
var outer_data = map__27104__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27104__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var sfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"sfn","sfn",-736336514));
var sargs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"sargs","sargs",1421118304));
var sync_signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526));
var in_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"in-id","in-id",2013544614));
var local_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"local?","local?",-1422786101));
var sync_atom_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"sync-atom-idx","sync-atom-idx",526705995));
var direct_sync_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"direct-sync?","direct-sync?",-1145947346));
var sync_atom_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"sync-atom-id","sync-atom-id",-1919513778));
var opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"opts","opts",155075701));
var transfers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27105__$1,new cljs.core.Keyword(null,"transfers","transfers",2123810614));
...
var len__5769__auto___27218 = arguments.length;
var i__5770__auto___27219 = (0);
while(true){
if((i__5770__auto___27219 < len__5769__auto___27218)){
args__5775__auto__.push((arguments[i__5770__auto___27219]));

var G__27220 = (i__5770__auto___27219 + (1));
i__5770__auto___27219 = G__27220;
continue;
} else {
}
break;
...
(cljs_thread.in$.do_in.cljs$core$IFn$_invoke$arity$variadic = (function (id,p__27117){
var vec__27118 = p__27117;
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27118,(0),null);
var afn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27118,(1),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27118,(2),null);
...
var vec__27121 = (cljs.core.truth_(afn)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [afn,args], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,null], null));
var afn__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27121,(0),null);
var args__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27121,(1),null);
...
var x27125 = cljs.core.clone(p);
(x27125.cljs_thread$id$IDable$ = cljs.core.PROTOCOL_SENTINEL);

(x27125.cljs_thread$id$IDable$get_id$arity$1 = (function (___$2){
var ___$3 = this;
return in_id;
}));

(x27125.cljs$core$IPending$ = cljs.core.PROTOCOL_SENTINEL);

(x27125.cljs$core$IPending$_realized_QMARK_$arity$1 = (function (___$2){
var ___$3 = this;
return cljs.core.deref(resolved_QMARK_);
}));

(x27125.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x27125.cljs$core$IDeref$_deref$arity$1 = (function (___$2){
var ___$3 = this;
...
/** @this {Function} */
(cljs_thread.in$.do_in.cljs$lang$applyTo = (function (seq27115){
var G__27116 = cljs.core.first(seq27115);
var seq27115__$1 = cljs.core.next(seq27115);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27116,seq27115__$1);
}));
