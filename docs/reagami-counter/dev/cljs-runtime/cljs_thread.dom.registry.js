...
var temp__5823__auto___26606 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs_thread.dom.registry.handle__GT_obj),handle);
if(cljs.core.truth_(temp__5823__auto___26606)){
var obj_26607 = temp__5823__auto___26606;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(cljs_thread.dom.registry.handle__GT_obj,cljs.core.dissoc,handle);

cljs_thread.dom.registry.obj__GT_handle.delete(obj_26607);
} else {
}
...
var arr = [];
var n__5636__auto___26618 = result.length;
var i_26619 = (0);
while(true){
if((i_26619 < n__5636__auto___26618)){
arr.push((function (){var G__26570 = result.item(i_26619);
return (cljs_thread.dom.registry.result__GT_wire.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.dom.registry.result__GT_wire.cljs$core$IFn$_invoke$arity$1(G__26570) : cljs_thread.dom.registry.result__GT_wire.call(null, G__26570));
})());

var G__26620 = (i_26619 + (1));
i_26619 = G__26620;
continue;
} else {
}
...
var G__26583 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),event.type], null);
var G__26583__$1 = (cljs.core.truth_(target)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26583,new cljs.core.Keyword(null,"target","target",253001721),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handle","handle",1538948854),cljs_thread.dom.registry.register_BANG_(target),new cljs.core.Keyword(null,"type","type",1174270348),(function (){var or__5045__auto__ = target.nodeName;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return "EventTarget";
