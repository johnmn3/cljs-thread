...
var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21598 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21598(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21604 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21604(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21606 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21606(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21608 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21608(reader);
}
});
...
var G__21643 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21644 = s.append(c);
c = G__21643;
s = G__21644;
continue;
}
