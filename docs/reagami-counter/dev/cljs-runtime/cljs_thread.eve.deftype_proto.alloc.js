...
var temp__5823__auto__ = (function (){var G__23921 = s_atom_env;
if((G__23921 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"sab","sab",422570093).cljs$core$IFn$_invoke$arity$1(G__23921);
}
})();
...
var temp__5823__auto___24460 = cljs_thread.eve.shared_atom._STAR_global_atom_instance_STAR_;
if(cljs.core.truth_(temp__5823__auto___24460)){
var inst_24461 = temp__5823__auto___24460;
cljs_thread.eve.deftype_proto.alloc.register_legacy_env_BANG_(cljs_thread.eve.shared_atom.get_env(inst_24461));
} else {
}
}
...
var G__24466 = (i__5770__auto___24465 + (1));
i__5770__auto___24465 = G__24466;
continue;
} else {
}
break;
...
(cljs_thread.eve.deftype_proto.alloc.init_slab_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (class_idx,p__23959){
var map__23960 = p__23959;
var map__23960__$1 = cljs.core.__destructure_map(map__23960);
var capacity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23960__$1,new cljs.core.Keyword(null,"capacity","capacity",72689734));
...
var map__23961 = layout;
var map__23961__$1 = cljs.core.__destructure_map(map__23961);
var total_bytes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23961__$1,new cljs.core.Keyword(null,"total-bytes","total-bytes",1693967112));
var bitmap_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23961__$1,new cljs.core.Keyword(null,"bitmap-offset","bitmap-offset",-54089933));
var bitmap_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23961__$1,new cljs.core.Keyword(null,"bitmap-size","bitmap-size",-730951825));
var data_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23961__$1,new cljs.core.Keyword(null,"data-offset","data-offset",-712338495));
var total_blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23961__$1,new cljs.core.Keyword(null,"total-blocks","total-blocks",-168639763));
...
/** @this {Function} */
(cljs_thread.eve.deftype_proto.alloc.init_slab_BANG_.cljs$lang$applyTo = (function (seq23949){
var G__23950 = cljs.core.first(seq23949);
var seq23949__$1 = cljs.core.next(seq23949);
...
var args__5775__auto__ = [];
var len__5769__auto___24491 = arguments.length;
var i__5770__auto___24492 = (0);
while(true){
if((i__5770__auto___24492 < len__5769__auto___24491)){
args__5775__auto__.push((arguments[i__5770__auto___24492]));

var G__24493 = (i__5770__auto___24492 + (1));
i__5770__auto___24492 = G__24493;
continue;
} else {
}
break;
...
(cljs_thread.eve.deftype_proto.alloc.init_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__24000){
var map__24001 = p__24000;
var map__24001__$1 = cljs.core.__destructure_map(map__24001);
var capacities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24001__$1,new cljs.core.Keyword(null,"capacities","capacities",-1666536173),cljs.core.PersistentArrayMap.EMPTY);
var slab_promises = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function cljs_thread$eve$deftype_proto$alloc$iter__24003(s__24004){
return (new cljs.core.LazySeq(null,(function (){
var s__24004__$1 = s__24004;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__24004__$1);
if(temp__5823__auto__){
var s__24004__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24004__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__24004__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__24006 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__24005 = (0);
while(true){
if((i__24005 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__24005);
cljs.core.chunk_append(b__24006,(function (){var cap = cljs.core.get.cljs$core$IFn$_invoke$arity$3(capacities,i,cljs_thread.eve.deftype_proto.data.default_capacity_for_class(i));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24006),cljs_thread$eve$deftype_proto$alloc$iter__24003(cljs.core.chunk_rest(s__24004__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24006),null);
}
} else {
var i = cljs.core.first(s__24004__$2);
...
return cljs_thread.eve.deftype_proto.alloc.init_slab_BANG_.cljs$core$IFn$_invoke$arity$variadic(i,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"capacity","capacity",72689734),cap], 0));
})(),cljs_thread$eve$deftype_proto$alloc$iter__24003(cljs.core.rest(s__24004__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(cljs_thread.eve.deftype_proto.alloc.init_BANG_.cljs$lang$applyTo = (function (seq23993){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23993));
}));
...
var n__5636__auto___24502 = (256);
var slot_idx_24503 = (0);
while(true){
if((slot_idx_24503 < n__5636__auto___24502)){
var slot_byte_offset_24504 = (cljs_thread.eve.deftype_proto.data.ROOT_WORKER_REGISTRY_START + (slot_idx_24503 * (24)));
Atomics.store(i32,(slot_byte_offset_24504 / (4)),(0));

var G__24513 = (slot_idx_24503 + (1));
slot_idx_24503 = G__24513;
continue;
} else {
}
break;
...
var sabs = [];
var n__5636__auto___24518 = (6);
var i_24519 = (0);
while(true){
if((i_24519 < n__5636__auto___24518)){
sabs.push(cljs_thread.eve.deftype_proto.wasm.slab_buffer(i_24519));
...
var n__5636__auto___24521 = (6);
var i_24522 = (0);
while(true){
if((i_24522 < n__5636__auto___24521)){
var sab_24523 = ((cljs.core.array_QMARK_(slab_sabs))?(slab_sabs[i_24522]):cljs.core.nth.cljs$core$IFn$_invoke$arity$2(slab_sabs,i_24522));
cljs_thread.eve.deftype_proto.wasm.register_slab_instance_from_sab_BANG_(i_24522,sab_24523);

cljs_thread.eve.deftype_proto.alloc.populate_slab_caches_from_header_BANG_(i_24522,sab_24523);

var G__24524 = (i_24522 + (1));
i_24522 = G__24524;
continue;
} else {
}
...
var G__24530 = (candidate + (1));
var G__24531 = wrapped_QMARK_;
start_bit = G__24530;
wrapped_QMARK_ = G__24531;
continue;
}
} else {
...
var cursor = Atomics.load(i32_view,((16) / (4)));
var results = [];
var start_bit_24538 = cursor;
var wrapped_QMARK__24539 = false;
while(true){
if((results.length < max_count)){
var candidate_24540 = cljs_thread.eve.deftype_proto.wasm.bitmap_find_free(class_idx,bm_offset,total_bits,start_bit_24538);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(candidate_24540,(-1))){
if(cljs_thread.eve.deftype_proto.wasm.bitmap_alloc_cas_BANG_(class_idx,bm_offset,candidate_24540)){
results.push(cljs_thread.eve.deftype_proto.alloc.encode_slab_offset(class_idx,candidate_24540));

var G__24541 = (candidate_24540 + (1));
var G__24542 = wrapped_QMARK__24539;
start_bit_24538 = G__24541;
wrapped_QMARK__24539 = G__24542;
continue;
} else {
var G__24543 = (candidate_24540 + (1));
var G__24544 = wrapped_QMARK__24539;
start_bit_24538 = G__24543;
wrapped_QMARK__24539 = G__24544;
continue;
}
} else {
if(((cljs.core.not(wrapped_QMARK__24539)) && ((cursor > (0))))){
var G__24545 = (0);
var G__24546 = true;
start_bit_24538 = G__24545;
wrapped_QMARK__24539 = G__24546;
continue;
} else {
...
if((results.length > (0))){
var last_offset_24547 = (results[(results.length - (1))]);
var last_block_24548 = cljs_thread.eve.deftype_proto.alloc.decode_block_idx(last_offset_24547);
Atomics.store(i32_view,((16) / (4)),cljs.core.mod((last_block_24548 + (1)),total_bits));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function cljs_thread$eve$deftype_proto$alloc$all_slab_stats_$_iter__24363(s__24364){
return (new cljs.core.LazySeq(null,(function (){
var s__24364__$1 = s__24364;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__24364__$1);
if(temp__5823__auto__){
var s__24364__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24364__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__24364__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__24366 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__24365 = (0);
while(true){
if((i__24365 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__24365);
cljs.core.chunk_append(b__24366,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,cljs_thread.eve.deftype_proto.alloc.slab_stats(i)], null));

var G__24575 = (i__24365 + (1));
i__24365 = G__24575;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24366),cljs_thread$eve$deftype_proto$alloc$all_slab_stats_$_iter__24363(cljs.core.chunk_rest(s__24364__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24366),null);
}
} else {
var i = cljs.core.first(s__24364__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,cljs_thread.eve.deftype_proto.alloc.slab_stats(i)], null),cljs_thread$eve$deftype_proto$alloc$all_slab_stats_$_iter__24363(cljs.core.rest(s__24364__$2)));
}
} else {
return null;
}
