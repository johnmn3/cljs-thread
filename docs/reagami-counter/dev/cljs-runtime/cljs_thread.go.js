...
var map__26395 = sync_channel;
var map__26395__$1 = cljs.core.__destructure_map(map__26395);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26395__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26395__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
...
var G__26414 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Error in remote call",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),result], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__26414) : reject.call(null, G__26414));
} else {
...
return Promise.resolve((function (){var G__26430 = cljs.core.deref(x);
return (continuation.cljs$core$IFn$_invoke$arity$1 ? continuation.cljs$core$IFn$_invoke$arity$1(G__26430) : continuation.call(null, G__26430));
})());
}
});
/**
...
var len__5769__auto___26527 = arguments.length;
var i__5770__auto___26528 = (0);
while(true){
if((i__5770__auto___26528 < len__5769__auto___26527)){
args__5775__auto__.push((arguments[i__5770__auto___26528]));

var G__26532 = (i__5770__auto___26528 + (1));
i__5770__auto___26528 = G__26532;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_thread.go.applier.cljs$lang$applyTo = (function (seq26434){
var G__26435 = cljs.core.first(seq26434);
var seq26434__$1 = cljs.core.next(seq26434);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26435,seq26434__$1);
}));
