...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271),(new SharedArrayBuffer((8))),new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196),(function (){var G__26226 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs_thread.eve.atom.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.eve.atom.cljs$core$IFn$_invoke$arity$1(G__26226) : cljs_thread.eve.atom.call(null, G__26226));
})()], null);
}));
 ...
 */
cljs_thread.sync.deliver_response = (function cljs_thread$sync$deliver_response(p__26232,in_id,result){
var map__26233 = p__26232;
var map__26233__$1 = cljs.core.__destructure_map(map__26233);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26233__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26233__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
...
var map__26242 = sync_channel;
var map__26242__$1 = cljs.core.__destructure_map(map__26242);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26242__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26242__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
var signal_i32 = (new Int32Array(signal_sab));
 ...
 */
cljs_thread.sync.reset_sync_channel_BANG_ = (function cljs_thread$sync$reset_sync_channel_BANG_(p__26246){
var map__26247 = p__26246;
var map__26247__$1 = cljs.core.__destructure_map(map__26247);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26247__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var signal_i32 = (new Int32Array(signal_sab));
...
var len__5769__auto___26380 = arguments.length;
var i__5770__auto___26381 = (0);
while(true){
if((i__5770__auto___26381 < len__5769__auto___26380)){
args__5775__auto__.push((arguments[i__5770__auto___26381]));

var G__26382 = (i__5770__auto___26381 + (1));
i__5770__auto___26381 = G__26382;
continue;
} else {
}
break;
...
(cljs_thread.sync.request.cljs$core$IFn$_invoke$arity$variadic = (function (getter,p__26257){
var map__26258 = p__26257;
var map__26258__$1 = cljs.core.__destructure_map(map__26258);
var opts = map__26258__$1;
var resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26258__$1,new cljs.core.Keyword(null,"resolve","resolve",-1584445482));
var reject = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26258__$1,new cljs.core.Keyword(null,"reject","reject",1415953113));
var no_park = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26258__$1,new cljs.core.Keyword(null,"no-park","no-park",-2136886220));
var max_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26258__$1,new cljs.core.Keyword(null,"max-time","max-time",857408479));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26258__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
/** @this {Function} */
(cljs_thread.sync.request.cljs$lang$applyTo = (function (seq26250){
var G__26251 = cljs.core.first(seq26250);
var seq26250__$1 = cljs.core.next(seq26250);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26251,seq26250__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___26409 = arguments.length;
var i__5770__auto___26410 = (0);
while(true){
if((i__5770__auto___26410 < len__5769__auto___26409)){
args__5775__auto__.push((arguments[i__5770__auto___26410]));

var G__26411 = (i__5770__auto___26410 + (1));
i__5770__auto___26410 = G__26411;
continue;
} else {
}
break;
...
(cljs_thread.sync.send_response.cljs$core$IFn$_invoke$arity$variadic = (function (payload,p__26271){
var vec__26272 = p__26271;
var _db_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26272,(0),null);
cljs_thread.sync.throw_if_non_blocking();
...
/** @this {Function} */
(cljs_thread.sync.send_response.cljs$lang$applyTo = (function (seq26260){
var G__26261 = cljs.core.first(seq26260);
var seq26260__$1 = cljs.core.next(seq26260);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26261,seq26260__$1);
}));
...
cljs_thread.sync.wrap_derefable = (function cljs_thread$sync$wrap_derefable(p__26283){
var map__26284 = p__26283;
var map__26284__$1 = cljs.core.__destructure_map(map__26284);
var data = map__26284__$1;
var promise_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26284__$1,new cljs.core.Keyword(null,"promise?","promise?",-1924347409));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26284__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return (new Promise((cljs.core.truth_(no_delay_QMARK_)?(function (p1__26281_SHARP_,p2__26282_SHARP_){
return cljs_thread.sync.request.cljs$core$IFn$_invoke$arity$variadic(id__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"resolve","resolve",-1584445482),p1__26281_SHARP_,new cljs.core.Keyword(null,"reject","reject",1415953113),p2__26282_SHARP_], null)], 0));
}):(function (){
return id__$1;
...
var obj = (function (){var x26309 = cljs.core.clone(p);
(x26309.cljs_thread$id$IDable$ = cljs.core.PROTOCOL_SENTINEL);

(x26309.cljs_thread$id$IDable$get_id$arity$1 = (function (_){
var ___$1 = this;
return id__$1;
}));

(x26309.cljs$core$IPending$ = cljs.core.PROTOCOL_SENTINEL);

(x26309.cljs$core$IPending$_realized_QMARK_$arity$1 = (function (_){
var ___$1 = this;
return cljs.core.deref(resolved_QMARK_);
}));

(x26309.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x26309.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (x,writer,opts){
var x__$1 = this;
...
(x26309.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x26309.cljs$core$IDeref$_deref$arity$1 = (function (_){
var ___$1 = this;
 ...
 */
cljs_thread.sync.wrap_derefable_direct = (function cljs_thread$sync$wrap_derefable_direct(p__26335){
var map__26336 = p__26335;
var map__26336__$1 = cljs.core.__destructure_map(map__26336);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26336__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var sync_channel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26336__$1,new cljs.core.Keyword(null,"sync-channel","sync-channel",74563328));
var resolved_QMARK_ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(false);
var resolved_value = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
var obj = (function (){var x26341 = cljs.core.clone(id);
(x26341.cljs_thread$id$IDable$ = cljs.core.PROTOCOL_SENTINEL);

(x26341.cljs_thread$id$IDable$get_id$arity$1 = (function (_){
var ___$1 = this;
return id;
}));

(x26341.cljs$core$IPending$ = cljs.core.PROTOCOL_SENTINEL);

(x26341.cljs$core$IPending$_realized_QMARK_$arity$1 = (function (_){
var ___$1 = this;
return cljs.core.deref(resolved_QMARK_);
}));

(x26341.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x26341.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (x,writer,opts){
var x__$1 = this;
...
(x26341.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x26341.cljs$core$IDeref$_deref$arity$1 = (function (_){
var ___$1 = this;
