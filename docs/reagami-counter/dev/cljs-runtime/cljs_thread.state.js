...
var len__5769__auto___23079 = arguments.length;
var i__5770__auto___23080 = (0);
while(true){
if((i__5770__auto___23080 < len__5769__auto___23079)){
args__5775__auto__.push((arguments[i__5770__auto___23080]));

var G__23081 = (i__5770__auto___23080 + (1));
i__5770__auto___23080 = G__23081;
continue;
} else {
}
break;
...
(cljs_thread.state.shake.cljs$core$IFn$_invoke$arity$variadic = (function (atm,p__23054){
var map__23056 = p__23054;
var map__23056__$1 = cljs.core.__destructure_map(map__23056);
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__23056__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194),(30));
var msg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23056__$1,new cljs.core.Keyword(null,"msg","msg",-1386103444));
var limit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23056__$1,new cljs.core.Keyword(null,"limit","limit",-1355822363));
var effect = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23056__$1,new cljs.core.Keyword(null,"effect","effect",347343289));
...
/** @this {Function} */
(cljs_thread.state.shake.cljs$lang$applyTo = (function (seq23045){
var G__23046 = cljs.core.first(seq23045);
var seq23045__$1 = cljs.core.next(seq23045);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23046,seq23045__$1);
}));
...
var self_23089 = cljs_thread.platform.self_ref();
var caller_23090 = new cljs.core.Keyword(null,"caller","caller",-1275362879).cljs$core$IFn$_invoke$arity$1(cljs_thread.env.data);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_thread.state.peers,cljs.core.assoc,new cljs.core.Keyword(null,"parent","parent",-878878779),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"parent","parent",-878878779),new cljs.core.Keyword(null,"w","w",354169001),self_23089,new cljs.core.Keyword(null,"port","port",1534937262),self_23089], null));

if(cljs_thread.env.in_root_QMARK_()){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_thread.state.peers,cljs.core.assoc,new cljs.core.Keyword(null,"screen","screen",1990059748),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"screen","screen",1990059748),new cljs.core.Keyword(null,"w","w",354169001),self_23089,new cljs.core.Keyword(null,"port","port",1534937262),self_23089], null));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(caller_23090,new cljs.core.Keyword(null,"screen","screen",1990059748))){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_thread.state.peers,cljs.core.assoc,new cljs.core.Keyword(null,"screen","screen",1990059748),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"screen","screen",1990059748),new cljs.core.Keyword(null,"w","w",354169001),self_23089,new cljs.core.Keyword(null,"port","port",1534937262),self_23089], null));
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_thread.state.peers,cljs.core.assoc,new cljs.core.Keyword(null,"root","root",-448657453),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"root","root",-448657453),new cljs.core.Keyword(null,"w","w",354169001),self_23089,new cljs.core.Keyword(null,"port","port",1534937262),self_23089], null));
