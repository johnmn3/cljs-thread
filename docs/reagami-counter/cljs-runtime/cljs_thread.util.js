...
var G__19984 = s;
var G__19984__$1 = (((G__19984 == null))?null:cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19984));
var G__19984__$2 = (((G__19984__$1 == null))?null:(function (p1__19983_SHARP_){
if(cljs.core.truth_(p1__19983_SHARP_.startsWith("?"))){
return cljs.core.rest(p1__19983_SHARP_);
} else {
return cljs.core.seq(p1__19983_SHARP_);
}
})(G__19984__$1));
var G__19984__$3 = (((G__19984__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,G__19984__$2));
var G__19984__$4 = (((G__19984__$3 == null))?null:goog.string.urlDecode(G__19984__$3));
if((G__19984__$4 == null)){
return null;
} else {
return clojure.edn.read_string.cljs$core$IFn$_invoke$arity$1(G__19984__$4);
}
});
...
var G__19993 = (i__5770__auto___19992 + (1));
i__5770__auto___19992 = G__19993;
continue;
} else {
}
break;
...
(cljs_thread.util.gen_id.cljs$core$IFn$_invoke$arity$variadic = (function (p__19986){
var vec__19987 = p__19986;
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19987,(0),null);
...
/** @this {Function} */
(cljs_thread.util.gen_id.cljs$lang$applyTo = (function (seq19985){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19985));
}));
...
var os = require('os');
return (function (){var fexpr__19990 = (os["cpus"]);
return (fexpr__19990.cljs$core$IFn$_invoke$arity$0 ? fexpr__19990.cljs$core$IFn$_invoke$arity$0() : fexpr__19990.call(null, ));
})().length;
} else {
return (4);
...
if((typeof cljs_thread !== 'undefined') && (typeof cljs_thread.util !== 'undefined') && (typeof cljs_thread.util.cached_user_agent !== 'undefined')){
} else {
cljs_thread.util.cached_user_agent = (((((typeof navigator !== 'undefined')) && ((!((navigator == null))))))?navigator.userAgent:null);
}
...
return (cljs_thread.util.cached_user_agent.indexOf(browser_string) > (-1));
} else {
return false;
}
});
...
return ((cljs_thread.util.in_browser_QMARK_("MSIE")) || (cljs_thread.util.in_browser_QMARK_("rv:")));
});
...
return ((cljs_thread.util.in_browser_QMARK_("Safari")) && ((!(cljs_thread.util.in_chrome_QMARK_()))));
});
cljs_thread.util.in_opera_QMARK_ = (function cljs_thread$util$in_opera_QMARK_(){
return ((cljs_thread.util.in_browser_QMARK_("OP")) && ((!(cljs_thread.util.in_chrome_QMARK_()))));
});
