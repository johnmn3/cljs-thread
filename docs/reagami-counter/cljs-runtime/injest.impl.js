...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28535_SHARP_){
if((!(cljs.core.coll_QMARK_(p1__28535_SHARP_)))){
return p1__28535_SHARP_;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(p1__28535_SHARP_))){
return cljs.core.first(p1__28535_SHARP_);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__28535_SHARP_),cljs.core.rest(p1__28535_SHARP_));
}
}
}),xfs));
});
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__28540_SHARP_){
if(cljs.core.not((function (){var and__5043__auto__ = (function (){var G__28545 = cljs.core.first(p1__28540_SHARP_);
return (t_pred.cljs$core$IFn$_invoke$arity$1 ? t_pred.cljs$core$IFn$_invoke$arity$1(G__28545) : t_pred.call(null, G__28545));
})();
if(cljs.core.truth_(and__5043__auto__)){
return (!((cljs.core.count(p1__28540_SHARP_) < minimum_group_size)));
} else {
...
return (new cljs.core.List(null,(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,t_fn,null,(1),null)),(new cljs.core.List(null,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.vec,p1__28540_SHARP_),null,(1),null))))),null,(1),null)),null,(1),null));
}
}),cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p1__28539_SHARP_){
return (t_pred.cljs$core$IFn$_invoke$arity$1 ? t_pred.cljs$core$IFn$_invoke$arity$1(p1__28539_SHARP_) : t_pred.call(null, p1__28539_SHARP_));
...
if(((cljs.core.seq_QMARK_(form)) && (cljs.core.not((function (){var G__28565 = cljs.core.first(form);
return (injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1 ? injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1(G__28565) : injest.impl.protected_fns.call(null, G__28565));
})())))){
...
if(((cljs.core.seq_QMARK_(form)) && (cljs.core.not((function (){var G__28566 = cljs.core.first(form);
return (injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1 ? injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1(G__28566) : injest.impl.protected_fns.call(null, G__28566));
})())))){
