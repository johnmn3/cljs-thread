...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23871)].join('')));
...
var G__23877 = kw;
var G__23877__$1 = (((G__23877 instanceof cljs.core.Keyword))?G__23877.fqn:null);
switch (G__23877__$1) {
case "uint8":
return (1);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23878)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23880)].join('')));
...
var self__ = this;
var this$ = this;
return ["#eve/array ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs_thread.eve.array.subtype__GT_type_kw(self__.subtype_code))," [",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.take.cljs$core$IFn$_invoke$arity$2((10),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23890_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(this$,p1__23890_SHARP_);
...
var i_24288 = (0);
while(true){
if((i_24288 < (function (){var x__5133__auto__ = (20);
var y__5134__auto__ = self__.length;
return ((x__5133__auto__ < y__5134__auto__) ? x__5133__auto__ : y__5134__auto__);
})())){
if((i_24288 > (0))){
...
cljs.core._write(writer,cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i_24288)));

var G__24289 = (i_24288 + (1));
i_24288 = G__24289;
continue;
} else {
}
...
if((i < self__.length)){
var G__24294 = (i + (1));
var G__24295 = (((31) * h) + cljs.core.hash(this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i)));
i = G__24294;
h = G__24295;
continue;
} else {
...
while(true){
if((i < self__.length)){
var result = (function (){var G__23918 = acc;
var G__23919 = this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__23918,G__23919) : f.call(null, G__23918,G__23919));
})();
...
while(true){
if((i < self__.length)){
var result = (function (){var G__23921 = acc;
var G__23922 = this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__23921,G__23922) : f.call(null, G__23921,G__23922));
})();
if(cljs.core.reduced_QMARK_(result)){
return cljs.core.deref(result);
} else {
...
var this$__$1 = this;
if((self__.length > (0))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23891_SHARP_){
return this$__$1.cljs$core$IIndexed$_nth$arity$2(null, p1__23891_SHARP_);
...
var self__ = this;
var self__ = this;
var G__23925 = (arguments.length - (1));
switch (G__23925) {
case (1):
...
(cljs_thread.eve.array.EveArray.prototype.apply = (function (self__,args23900){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args23900)));
}));
...
var map__23933 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__23933__$1 = cljs.core.__destructure_map(map__23933);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23933__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23933__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23933__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23933__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
...
if(atomic){
var n__5636__auto___24362 = n;
var i_24365 = (0);
while(true){
if((i_24365 < n__5636__auto___24362)){
Atomics.store(view,(base_idx + i_24365),fill_val);

var G__24368 = (i_24365 + (1));
i_24365 = G__24368;
continue;
} else {
}
...
var n__5636__auto___24369 = n;
var i_24370 = (0);
while(true){
if((i_24370 < n__5636__auto___24369)){
(view[(base_idx + i_24370)] = fill_val);

var G__24371 = (i_24370 + (1));
i_24370 = G__24371;
continue;
} else {
}
...
var subtype = cljs_thread.eve.array.type_kw__GT_subtype(type_kw);
var map__23934 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__23934__$1 = cljs.core.__destructure_map(map__23934);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23934__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23934__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23934__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23934__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
var elem_shift = cljs_thread.eve.array.subtype__GT_elem_shift(subtype);
var atomic = cljs_thread.eve.array.subtype__GT_atomic_QMARK_(subtype);
var view = cljs_thread.eve.array.make_typed_view(sab,subtype);
var arr = (new cljs_thread.eve.array.EveArray(sab,block_start,offset,n,descriptor_idx,subtype,elem_shift,atomic,view,null,null));
var base_idx = (offset >>> elem_shift);
if(atomic){
var n__5636__auto___24372 = n;
var i_24373 = (0);
while(true){
if((i_24373 < n__5636__auto___24372)){
Atomics.store(view,(base_idx + i_24373),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(v,i_24373));

var G__24374 = (i_24373 + (1));
i_24373 = G__24374;
continue;
} else {
}
...
var n__5636__auto___24376 = n;
var i_24377 = (0);
while(true){
if((i_24377 < n__5636__auto___24376)){
(view[(base_idx + i_24377)] = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(v,i_24377));

var G__24378 = (i_24377 + (1));
i_24377 = G__24378;
continue;
} else {
}
...
var view_24383 = arr.typed_view;
var base_24384 = (arr.offset >>> arr.elem_shift);
if(cljs.core.truth_(arr.atomic_QMARK_)){
Atomics.store(view_24383,(base_24384 + idx),val);
} else {
(view_24383[(base_24384 + idx)] = val);
}
...
var v = result.value;
return Promise.resolve((function (){var G__23953 = v;
switch (G__23953) {
case "ok":
return new cljs.core.Keyword(null,"ok","ok",967785236);
...
while(true){
if((i < len)){
var result = (function (){var G__23972 = acc;
var G__23973 = i;
var G__23974 = cljs_thread.eve.array.aget(arr,i);
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__23972,G__23973,G__23974) : f.call(null, G__23972,G__23973,G__23974));
})();
if(cljs.core.reduced_QMARK_(result)){
return cljs.core.deref(result);
} else {
...
var n__5636__auto___24496 = len;
var i_24499 = (0);
while(true){
if((i_24499 < n__5636__auto___24496)){
cljs_thread.eve.array.aset_BANG_(result,i_24499,(function (){var G__23997 = i_24499;
var G__23998 = cljs_thread.eve.array.aget(arr,i_24499);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__23997,G__23998) : f.call(null, G__23997,G__23998));
})());

var G__24504 = (i_24499 + (1));
i_24499 = G__24504;
continue;
} else {
}
...
var len = arr.length;
var n__5636__auto___24507 = len;
var i_24509 = (0);
while(true){
if((i_24509 < n__5636__auto___24507)){
cljs_thread.eve.array.aset_BANG_(arr,i_24509,(function (){var G__24007 = i_24509;
var G__24008 = cljs_thread.eve.array.aget(arr,i_24509);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__24007,G__24008) : f.call(null, G__24007,G__24008));
})());

var G__24511 = (i_24509 + (1));
i_24509 = G__24511;
continue;
} else {
}
...
while(true){
if((i_24519 < end__$1)){
cljs_thread.eve.array.aset_BANG_(arr,i_24519,val);

var G__24521 = (i_24519 + (1));
i_24519 = G__24521;
continue;
} else {
}
...
var n__5636__auto___24528 = len;
var i_24529 = (0);
while(true){
if((i_24529 < n__5636__auto___24528)){
cljs_thread.eve.array.aset_BANG_(dest,(dest_start + i_24529),cljs_thread.eve.array.aget(src,(src_start + i_24529)));

var G__24531 = (i_24529 + (1));
i_24529 = G__24531;
continue;
} else {
}
...
var dest_byte_offset_24541 = (dest.offset + (dest_start * (4)));
var src_byte_offset_24542 = (src.offset + (src_start * (4)));
cljs_thread.eve.wasm_mem.simd_copy_i32_BANG_(dest_byte_offset_24541,src_byte_offset_24542,len);
} else {
}
...
var n = elem.length;
var map__24200 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__24200__$1 = cljs.core.__destructure_map(map__24200);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24200__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24200__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24200__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24200__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
var elem_shift = cljs_thread.eve.array.subtype__GT_elem_shift(subtype);
var atomic = cljs_thread.eve.array.subtype__GT_atomic_QMARK_(subtype);
var view = cljs_thread.eve.array.make_typed_view(sab,subtype);
var base_idx = (offset >>> elem_shift);
