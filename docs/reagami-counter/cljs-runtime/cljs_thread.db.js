...
var res = cljs.core.deref(cljs_thread.in$.do_in.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"db","db",993250759),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [k], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (in_id__20899__auto__,direct_sync_QMARK___20900__auto__,sync_signal_sab__20901__auto__,sync_atom_id__20902__auto__,sync_atom_idx__20903__auto__){
...
})),cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"yield?","yield?",-2100785447),(function (){var fexpr__20975 = cljs_thread.idb.idb_get(k,cljs_thread.db.yield$);
return (fexpr__20975.cljs$core$IFn$_invoke$arity$0 ? fexpr__20975.cljs$core$IFn$_invoke$arity$0() : fexpr__20975.call(null, ));
