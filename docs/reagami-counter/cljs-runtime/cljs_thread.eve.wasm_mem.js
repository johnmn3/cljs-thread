...
var buffer_22140 = memory.buffer;
cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_u8,(new Uint8Array(buffer_22140)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_i32,(new Int32Array(buffer_22140)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_f64,(new Float64Array(buffer_22140)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_dv,(new DataView(buffer_22140)));
...
var buffer_22142 = memory.buffer;
cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_u8,(new Uint8Array(buffer_22142)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_i32,(new Int32Array(buffer_22142)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_f64,(new Float64Array(buffer_22142)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_dv,(new DataView(buffer_22142)));
...
var G__22160 = (i + (1));
var G__22161 = cljs.core.imul((hash ^ (u8[(offset + i)])),(16777619));
i = G__22160;
hash = G__22161;
continue;
}
