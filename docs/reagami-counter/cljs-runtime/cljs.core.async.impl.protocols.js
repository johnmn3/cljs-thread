...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26731 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26731(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26739 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26739(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26749 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26749(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26755 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26755(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26767 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26767(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26783 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26783(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26794 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26794(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26803 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26803(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26815 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26815(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26830 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26830(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26847 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26847(b);
}
});
