...
var buffer_22120 = memory.buffer;
cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_u8,(new Uint8Array(buffer_22120)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_i32,(new Int32Array(buffer_22120)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_f64,(new Float64Array(buffer_22120)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_dv,(new DataView(buffer_22120)));
...
var buffer_22135 = memory.buffer;
cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_u8,(new Uint8Array(buffer_22135)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_i32,(new Int32Array(buffer_22135)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_f64,(new Float64Array(buffer_22135)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_dv,(new DataView(buffer_22135)));
...
var G__22179 = (i + (1));
var G__22180 = cljs.core.imul((hash ^ (u8[(offset + i)])),(16777619));
i = G__22179;
hash = G__22180;
continue;
}
