...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21596 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21596(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21597 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21597(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21599 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21599(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21601 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21601(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21603 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21603(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21605 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21605(reader);
}
});
...
var G__21639 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21640 = s.append(c);
c = G__21639;
s = G__21640;
continue;
}
