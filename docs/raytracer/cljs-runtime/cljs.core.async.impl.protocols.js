...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26728 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26728(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26742 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26742(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26761 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26761(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26770 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26770(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26791 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26791(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26801 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26801(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26813 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26813(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26827 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26827(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26837 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26837(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26855 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26855(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26884 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26884(b);
}
});
