...
var len__5769__auto___27263 = arguments.length;
var i__5770__auto___27264 = (0);
while(true){
if((i__5770__auto___27264 < len__5769__auto___27263)){
args__5775__auto__.push((arguments[i__5770__auto___27264]));

var G__27265 = (i__5770__auto___27264 + (1));
i__5770__auto___27264 = G__27265;
continue;
} else {
}
break;
...
(cljs_thread.idb.idb_set_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (k,data,p__27235){
var vec__27236 = p__27235;
var yield$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27236,(0),null);
...
(req.onsuccess = (function (p1__27222_SHARP_){
var res = (function (){var G__27239 = p1__27222_SHARP_;
var G__27239__$1 = (((G__27239 == null))?null:G__27239.target);
if((G__27239__$1 == null)){
return null;
} else {
return G__27239__$1.result;
}
})();
...
/** @this {Function} */
(cljs_thread.idb.idb_set_BANG_.cljs$lang$applyTo = (function (seq27223){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27224,G__27225,seq27223__$2);
}));
...
(req.onerror = (function (p1__27242_SHARP_){
(yield$.cljs$core$IFn$_invoke$arity$1 ? yield$.cljs$core$IFn$_invoke$arity$1(null) : yield$.call(null, null));

throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["idb-get failed getting ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join(''),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"k","k",-2146297393),k,new cljs.core.Keyword(null,"error","error",-978969032),p1__27242_SHARP_], null));
}));

return (req.onsuccess = (function (p1__27245_SHARP_){
var res = clojure.edn.read_string.cljs$core$IFn$_invoke$arity$1(p1__27245_SHARP_.target.result);
var G__27252 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"res","res",-1395007879),res], null);
return (yield$.cljs$core$IFn$_invoke$arity$1 ? yield$.cljs$core$IFn$_invoke$arity$1(G__27252) : yield$.call(null, G__27252));
}));
} else {
return null;
}
...
(request.onerror = (function (p1__27253_SHARP_){
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"idb-open-error","idb-open-error",576682558),p1__27253_SHARP_], 0));
}));

(request.onsuccess = (function (p1__27254_SHARP_){
cljs.core.reset_BANG_(cljs_thread.state.idb,p1__27254_SHARP_.target.result);

return cljs.core.reset_BANG_(cljs_thread.idb.open_QMARK_,true);
}));

return (request.onupgradeneeded = (function (p1__27255_SHARP_){
var db = p1__27255_SHARP_.target.result;
