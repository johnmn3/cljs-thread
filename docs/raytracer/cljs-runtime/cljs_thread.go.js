...
var map__26284 = sync_channel;
var map__26284__$1 = cljs.core.__destructure_map(map__26284);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26284__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26284__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
...
var G__26306 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Error in remote call",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),result], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__26306) : reject.call(null, G__26306));
} else {
...
return Promise.resolve((function (){var G__26343 = cljs.core.deref(x);
return (continuation.cljs$core$IFn$_invoke$arity$1 ? continuation.cljs$core$IFn$_invoke$arity$1(G__26343) : continuation.call(null, G__26343));
})());
}
});
/**
...
var i__5770__auto___26435 = (0);
while(true){
if((i__5770__auto___26435 < len__5769__auto___26433)){
args__5775__auto__.push((arguments[i__5770__auto___26435]));

var G__26441 = (i__5770__auto___26435 + (1));
i__5770__auto___26435 = G__26441;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_thread.go.applier.cljs$lang$applyTo = (function (seq26350){
var G__26351 = cljs.core.first(seq26350);
var seq26350__$1 = cljs.core.next(seq26350);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26351,seq26350__$1);
}));
