...
/**
 * Check if x is an OffscreenCanvas (transferable).
 */
cljs_thread.serial.offscreen_canvas_QMARK_ = (function cljs_thread$serial$offscreen_canvas_QMARK_(x){
return (((typeof OffscreenCanvas !== 'undefined')) && ((x instanceof OffscreenCanvas)));
});
/**
 * Check if x is a transferable object (typed array, ImageBitmap, or OffscreenCanvas).
 */
cljs_thread.serial.transferable_QMARK_ = (function cljs_thread$serial$transferable_QMARK_(x){
return ((cljs_thread.util.typed_array_QMARK_(x)) || (((cljs_thread.serial.image_bitmap_QMARK_(x)) || (cljs_thread.serial.offscreen_canvas_QMARK_(x)))));
});
/**
...
var no_transfer_QMARK_ = new cljs.core.Keyword(null,"no-transfer","no-transfer",1370526219).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(transfer_atom));
...
var or__5045__auto____$1 = buffer_is_sab_QMARK_;
if(cljs.core.truth_(or__5045__auto____$1)){
return or__5045__auto____$1;
} else {
return no_transfer_QMARK_;
}
}
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"obj","obj",981763962),form], null):new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"obj","obj",981763962),form,new cljs.core.Keyword(null,"transfer","transfer",327423400),((cljs_thread.serial.image_bitmap_QMARK_(form))?form:((cljs_thread.serial.offscreen_canvas_QMARK_(form))?form:buffer
))], null)));
}
...
if(((cljs.core.object_QMARK_(form)) && ((((!(cljs.core.map_QMARK_(form)))) && ((((!(cljs.core.vector_QMARK_(form)))) && ((((!(cljs.core.set_QMARK_(form)))) && ((((!(cljs.core.list_QMARK_(form)))) && ((!(cljs.core.seq_QMARK_(form)))))))))))))){
var c_tag = cljs_thread.serial.get_or_assign_ctag_BANG_(transfer_atom,form);
...
return clojure.walk.postwalk((function (p1__25744_SHARP_){
if(cljs.core.truth_(cljs_thread.serial.ct_marker_QMARK_(p1__25744_SHARP_))){
return get_transfer(new cljs.core.Keyword(null,"ctag","ctag",304756589).cljs$core$IFn$_invoke$arity$1(p1__25744_SHARP_));
} else {
if(cljs.core.truth_((function (){var and__5043__auto__ = typeof p1__25744_SHARP_ === 'string';
if(and__5043__auto__){
return p1__25744_SHARP_.startsWith("#cljs-thread/arg-fn");
} else {
return and__5043__auto__;
}
})())){
return eval(["(function () {return (",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(p1__25744_SHARP_,(20)),");})();"].join(''));
} else {
return p1__25744_SHARP_;
