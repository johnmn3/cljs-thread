...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.comp,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28479_SHARP_){
if((!(cljs.core.coll_QMARK_(p1__28479_SHARP_)))){
return p1__28479_SHARP_;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(p1__28479_SHARP_))){
return cljs.core.first(p1__28479_SHARP_);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__28479_SHARP_),cljs.core.rest(p1__28479_SHARP_));
}
}
}),xfs));
});
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__28484_SHARP_){
if(cljs.core.not((function (){var and__5043__auto__ = (function (){var G__28485 = cljs.core.first(p1__28484_SHARP_);
return (t_pred.cljs$core$IFn$_invoke$arity$1 ? t_pred.cljs$core$IFn$_invoke$arity$1(G__28485) : t_pred.call(null, G__28485));
})();
if(cljs.core.truth_(and__5043__auto__)){
return (!((cljs.core.count(p1__28484_SHARP_) < minimum_group_size)));
} else {
return and__5043__auto__;
}
})())){
return p1__28484_SHARP_;
} else {
return (new cljs.core.List(null,(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,t_fn,null,(1),null)),(new cljs.core.List(null,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.vec,p1__28484_SHARP_),null,(1),null))))),null,(1),null)),null,(1),null));
}
}),cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p1__28483_SHARP_){
return (t_pred.cljs$core$IFn$_invoke$arity$1 ? t_pred.cljs$core$IFn$_invoke$arity$1(p1__28483_SHARP_) : t_pred.call(null, p1__28483_SHARP_));
...
if(((cljs.core.seq_QMARK_(form)) && (cljs.core.not((function (){var G__28495 = cljs.core.first(form);
return (injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1 ? injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1(G__28495) : injest.impl.protected_fns.call(null, G__28495));
})())))){
...
if(((cljs.core.seq_QMARK_(form)) && (cljs.core.not((function (){var G__28510 = cljs.core.first(form);
return (injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1 ? injest.impl.protected_fns.cljs$core$IFn$_invoke$arity$1(G__28510) : injest.impl.protected_fns.call(null, G__28510));
})())))){
