...
var cljs_thread$eve$deftype_proto$data$IDirectSerialize$_direct_serialize$dyn_22035 = (function (this$){
...
return cljs_thread$eve$deftype_proto$data$IDirectSerialize$_direct_serialize$dyn_22035(this$);
}
});
...
var cljs_thread$eve$deftype_proto$data$ISabStorable$_sab_tag$dyn_22043 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return cljs_thread$eve$deftype_proto$data$ISabStorable$_sab_tag$dyn_22043(this$);
}
});

var cljs_thread$eve$deftype_proto$data$ISabStorable$_sab_encode$dyn_22046 = (function (this$,slab_env){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return cljs_thread$eve$deftype_proto$data$ISabStorable$_sab_encode$dyn_22046(this$,slab_env);
}
});

var cljs_thread$eve$deftype_proto$data$ISabStorable$_sab_dispose$dyn_22048 = (function (this$,slab_env){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return cljs_thread$eve$deftype_proto$data$ISabStorable$_sab_dispose$dyn_22048(this$,slab_env);
}
});
...
var cljs_thread$eve$deftype_proto$data$ISabRetirable$_sab_retire_diff_BANG_$dyn_22055 = (function (old_value,new_value,slab_env,mode){
...
return cljs_thread$eve$deftype_proto$data$ISabRetirable$_sab_retire_diff_BANG_$dyn_22055(old_value,new_value,slab_env,mode);
}
});
...
var cljs_thread$eve$deftype_proto$data$ISabpType$_sabp_type_key$dyn_22058 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return cljs_thread$eve$deftype_proto$data$ISabpType$_sabp_type_key$dyn_22058(this$);
}
});
...
var cljs_thread$eve$deftype_proto$data$IsEve$_eve_QMARK_$dyn_22060 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return cljs_thread$eve$deftype_proto$data$IsEve$_eve_QMARK_$dyn_22060(this$);
}
});
