...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271),(new SharedArrayBuffer((8))),new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196),(function (){var G__26156 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs_thread.eve.atom.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.eve.atom.cljs$core$IFn$_invoke$arity$1(G__26156) : cljs_thread.eve.atom.call(null, G__26156));
})()], null);
}));
 ...
 */
cljs_thread.sync.deliver_response = (function cljs_thread$sync$deliver_response(p__26161,in_id,result){
var map__26162 = p__26161;
var map__26162__$1 = cljs.core.__destructure_map(map__26162);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26162__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26162__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
...
var map__26164 = sync_channel;
var map__26164__$1 = cljs.core.__destructure_map(map__26164);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26164__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26164__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
var signal_i32 = (new Int32Array(signal_sab));
 ...
 */
cljs_thread.sync.reset_sync_channel_BANG_ = (function cljs_thread$sync$reset_sync_channel_BANG_(p__26167){
var map__26168 = p__26167;
var map__26168__$1 = cljs.core.__destructure_map(map__26168);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26168__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var signal_i32 = (new Int32Array(signal_sab));
...
var len__5769__auto___26282 = arguments.length;
var i__5770__auto___26283 = (0);
while(true){
if((i__5770__auto___26283 < len__5769__auto___26282)){
args__5775__auto__.push((arguments[i__5770__auto___26283]));

var G__26285 = (i__5770__auto___26283 + (1));
i__5770__auto___26283 = G__26285;
continue;
} else {
}
break;
...
(cljs_thread.sync.request.cljs$core$IFn$_invoke$arity$variadic = (function (getter,p__26178){
var map__26179 = p__26178;
var map__26179__$1 = cljs.core.__destructure_map(map__26179);
var opts = map__26179__$1;
var resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26179__$1,new cljs.core.Keyword(null,"resolve","resolve",-1584445482));
var reject = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26179__$1,new cljs.core.Keyword(null,"reject","reject",1415953113));
var no_park = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26179__$1,new cljs.core.Keyword(null,"no-park","no-park",-2136886220));
var max_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26179__$1,new cljs.core.Keyword(null,"max-time","max-time",857408479));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26179__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
/** @this {Function} */
(cljs_thread.sync.request.cljs$lang$applyTo = (function (seq26174){
var G__26175 = cljs.core.first(seq26174);
var seq26174__$1 = cljs.core.next(seq26174);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26175,seq26174__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___26299 = arguments.length;
var i__5770__auto___26300 = (0);
while(true){
if((i__5770__auto___26300 < len__5769__auto___26299)){
args__5775__auto__.push((arguments[i__5770__auto___26300]));

var G__26301 = (i__5770__auto___26300 + (1));
i__5770__auto___26300 = G__26301;
continue;
} else {
}
break;
...
(cljs_thread.sync.send_response.cljs$core$IFn$_invoke$arity$variadic = (function (payload,p__26187){
var vec__26188 = p__26187;
var _db_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26188,(0),null);
cljs_thread.sync.throw_if_non_blocking();
...
/** @this {Function} */
(cljs_thread.sync.send_response.cljs$lang$applyTo = (function (seq26185){
var G__26186 = cljs.core.first(seq26185);
var seq26185__$1 = cljs.core.next(seq26185);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26186,seq26185__$1);
}));
...
cljs_thread.sync.wrap_derefable = (function cljs_thread$sync$wrap_derefable(p__26209){
var map__26210 = p__26209;
var map__26210__$1 = cljs.core.__destructure_map(map__26210);
var data = map__26210__$1;
var promise_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26210__$1,new cljs.core.Keyword(null,"promise?","promise?",-1924347409));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26210__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return (new Promise((cljs.core.truth_(no_delay_QMARK_)?(function (p1__26207_SHARP_,p2__26208_SHARP_){
return cljs_thread.sync.request.cljs$core$IFn$_invoke$arity$variadic(id__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"resolve","resolve",-1584445482),p1__26207_SHARP_,new cljs.core.Keyword(null,"reject","reject",1415953113),p2__26208_SHARP_], null)], 0));
}):(function (){
return id__$1;
...
var obj = (function (){var x26218 = cljs.core.clone(p);
(x26218.cljs_thread$id$IDable$ = cljs.core.PROTOCOL_SENTINEL);

(x26218.cljs_thread$id$IDable$get_id$arity$1 = (function (_){
var ___$1 = this;
return id__$1;
}));

(x26218.cljs$core$IPending$ = cljs.core.PROTOCOL_SENTINEL);

(x26218.cljs$core$IPending$_realized_QMARK_$arity$1 = (function (_){
var ___$1 = this;
return cljs.core.deref(resolved_QMARK_);
}));

(x26218.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x26218.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (x,writer,opts){
var x__$1 = this;
...
(x26218.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x26218.cljs$core$IDeref$_deref$arity$1 = (function (_){
var ___$1 = this;
 ...
 */
cljs_thread.sync.wrap_derefable_direct = (function cljs_thread$sync$wrap_derefable_direct(p__26253){
var map__26254 = p__26253;
var map__26254__$1 = cljs.core.__destructure_map(map__26254);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26254__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var sync_channel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26254__$1,new cljs.core.Keyword(null,"sync-channel","sync-channel",74563328));
var resolved_QMARK_ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(false);
var resolved_value = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
var obj = (function (){var x26257 = cljs.core.clone(id);
(x26257.cljs_thread$id$IDable$ = cljs.core.PROTOCOL_SENTINEL);

(x26257.cljs_thread$id$IDable$get_id$arity$1 = (function (_){
var ___$1 = this;
return id;
}));

(x26257.cljs$core$IPending$ = cljs.core.PROTOCOL_SENTINEL);

(x26257.cljs$core$IPending$_realized_QMARK_$arity$1 = (function (_){
var ___$1 = this;
return cljs.core.deref(resolved_QMARK_);
}));

(x26257.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x26257.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (x,writer,opts){
var x__$1 = this;
...
(x26257.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x26257.cljs$core$IDeref$_deref$arity$1 = (function (_){
var ___$1 = this;
