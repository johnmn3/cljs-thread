...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23717)].join('')));
...
var G__23730 = kw;
var G__23730__$1 = (((G__23730 instanceof cljs.core.Keyword))?G__23730.fqn:null);
switch (G__23730__$1) {
case "uint8":
return (1);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23747)].join('')));
...
var self__ = this;
var this$ = this;
return ["#eve/array ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs_thread.eve.array.subtype__GT_type_kw(self__.subtype_code))," [",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.take.cljs$core$IFn$_invoke$arity$2((10),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23758_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(this$,p1__23758_SHARP_);
...
var i_24663 = (0);
while(true){
if((i_24663 < (function (){var x__5133__auto__ = (20);
var y__5134__auto__ = self__.length;
return ((x__5133__auto__ < y__5134__auto__) ? x__5133__auto__ : y__5134__auto__);
})())){
if((i_24663 > (0))){
...
cljs.core._write(writer,cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i_24663)));

var G__24664 = (i_24663 + (1));
i_24663 = G__24664;
continue;
} else {
}
...
if((i < self__.length)){
var G__24672 = (i + (1));
var G__24673 = (((31) * h) + cljs.core.hash(this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i)));
i = G__24672;
h = G__24673;
continue;
} else {
...
while(true){
if((i < self__.length)){
var result = (function (){var G__23892 = acc;
var G__23893 = this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i);
...
while(true){
if((i < self__.length)){
var result = (function (){var G__23898 = acc;
var G__23899 = this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__23898,G__23899) : f.call(null, G__23898,G__23899));
})();
if(cljs.core.reduced_QMARK_(result)){
return cljs.core.deref(result);
} else {
...
var this$__$1 = this;
if((self__.length > (0))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23762_SHARP_){
return this$__$1.cljs$core$IIndexed$_nth$arity$2(null, p1__23762_SHARP_);
...
var self__ = this;
var self__ = this;
var G__23911 = (arguments.length - (1));
switch (G__23911) {
case (1):
...
(cljs_thread.eve.array.EveArray.prototype.apply = (function (self__,args23771){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args23771)));
}));
...
var map__23964 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__23964__$1 = cljs.core.__destructure_map(map__23964);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23964__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23964__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23964__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23964__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
...
if(atomic){
var n__5636__auto___24714 = n;
var i_24715 = (0);
while(true){
if((i_24715 < n__5636__auto___24714)){
Atomics.store(view,(base_idx + i_24715),fill_val);

var G__24716 = (i_24715 + (1));
i_24715 = G__24716;
continue;
} else {
}
...
var n__5636__auto___24717 = n;
var i_24718 = (0);
while(true){
if((i_24718 < n__5636__auto___24717)){
(view[(base_idx + i_24718)] = fill_val);

var G__24719 = (i_24718 + (1));
i_24718 = G__24719;
continue;
} else {
}
...
var subtype = cljs_thread.eve.array.type_kw__GT_subtype(type_kw);
var map__23974 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__23974__$1 = cljs.core.__destructure_map(map__23974);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23974__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23974__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23974__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23974__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
var elem_shift = cljs_thread.eve.array.subtype__GT_elem_shift(subtype);
var atomic = cljs_thread.eve.array.subtype__GT_atomic_QMARK_(subtype);
var view = cljs_thread.eve.array.make_typed_view(sab,subtype);
var arr = (new cljs_thread.eve.array.EveArray(sab,block_start,offset,n,descriptor_idx,subtype,elem_shift,atomic,view,null,null));
var base_idx = (offset >>> elem_shift);
if(atomic){
var n__5636__auto___24735 = n;
var i_24736 = (0);
while(true){
if((i_24736 < n__5636__auto___24735)){
Atomics.store(view,(base_idx + i_24736),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(v,i_24736));

var G__24738 = (i_24736 + (1));
i_24736 = G__24738;
continue;
} else {
}
...
var n__5636__auto___24739 = n;
var i_24740 = (0);
while(true){
if((i_24740 < n__5636__auto___24739)){
(view[(base_idx + i_24740)] = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(v,i_24740));

var G__24747 = (i_24740 + (1));
i_24740 = G__24747;
continue;
} else {
}
...
var view_24751 = arr.typed_view;
var base_24752 = (arr.offset >>> arr.elem_shift);
if(cljs.core.truth_(arr.atomic_QMARK_)){
Atomics.store(view_24751,(base_24752 + idx),val);
} else {
(view_24751[(base_24752 + idx)] = val);
}
...
var v = result.value;
return Promise.resolve((function (){var G__24226 = v;
switch (G__24226) {
case "ok":
return new cljs.core.Keyword(null,"ok","ok",967785236);
...
while(true){
if((i < len)){
var result = (function (){var G__24287 = acc;
var G__24288 = i;
var G__24289 = cljs_thread.eve.array.aget(arr,i);
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__24287,G__24288,G__24289) : f.call(null, G__24287,G__24288,G__24289));
})();
if(cljs.core.reduced_QMARK_(result)){
return cljs.core.deref(result);
} else {
...
var n__5636__auto___24804 = len;
var i_24805 = (0);
while(true){
if((i_24805 < n__5636__auto___24804)){
cljs_thread.eve.array.aset_BANG_(result,i_24805,(function (){var G__24337 = i_24805;
var G__24338 = cljs_thread.eve.array.aget(arr,i_24805);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__24337,G__24338) : f.call(null, G__24337,G__24338));
})());
...
var len = arr.length;
var n__5636__auto___24807 = len;
var i_24808 = (0);
while(true){
if((i_24808 < n__5636__auto___24807)){
cljs_thread.eve.array.aset_BANG_(arr,i_24808,(function (){var G__24379 = i_24808;
var G__24380 = cljs_thread.eve.array.aget(arr,i_24808);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__24379,G__24380) : f.call(null, G__24379,G__24380));
})());

var G__24809 = (i_24808 + (1));
i_24808 = G__24809;
continue;
} else {
}
...
while(true){
if((i_24820 < end__$1)){
cljs_thread.eve.array.aset_BANG_(arr,i_24820,val);

var G__24826 = (i_24820 + (1));
i_24820 = G__24826;
continue;
} else {
}
...
var n__5636__auto___24828 = len;
var i_24829 = (0);
while(true){
if((i_24829 < n__5636__auto___24828)){
cljs_thread.eve.array.aset_BANG_(dest,(dest_start + i_24829),cljs_thread.eve.array.aget(src,(src_start + i_24829)));

var G__24830 = (i_24829 + (1));
i_24829 = G__24830;
continue;
} else {
}
...
var dest_byte_offset_24841 = (dest.offset + (dest_start * (4)));
var src_byte_offset_24842 = (src.offset + (src_start * (4)));
cljs_thread.eve.wasm_mem.simd_copy_i32_BANG_(dest_byte_offset_24841,src_byte_offset_24842,len);
} else {
}
...
var n = elem.length;
var map__24567 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__24567__$1 = cljs.core.__destructure_map(map__24567);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24567__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24567__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24567__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24567__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
var elem_shift = cljs_thread.eve.array.subtype__GT_elem_shift(subtype);
var atomic = cljs_thread.eve.array.subtype__GT_atomic_QMARK_(subtype);
var view = cljs_thread.eve.array.make_typed_view(sab,subtype);
var base_idx = (offset >>> elem_shift);
...
var alloc_result = (cljs.core.truth_(eve_env)?cljs_thread.eve.shared_atom.alloc(eve_env,block_size):null);
...
var block_offset = new cljs.core.Keyword(null,"offset","offset",296498311).cljs$core$IFn$_invoke$arity$1(alloc_result);
var sab = new cljs.core.Keyword(null,"sab","sab",422570093).cljs$core$IFn$_invoke$arity$1(eve_env);
var dv = (new DataView(sab));
var u8 = (new Uint8Array(sab));
dv.setUint8(block_offset,subtype);

dv.setUint32((block_offset + (1)),byte_len,true);

u8.set(byte_view,(block_offset + (5)));

return cljs_thread.eve.deftype_proto.serialize.encode_sab_pointer((27),block_offset);
} else {
