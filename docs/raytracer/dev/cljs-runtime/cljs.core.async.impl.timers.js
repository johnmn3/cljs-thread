...
var i_29134 = (0);
while(true){
if((i_29134 < arr.length)){
(arr[i_29134] = null);

var G__29135 = (i_29134 + (1));
i_29134 = G__29135;
continue;
} else {
}
...
var i_29154 = (self__.level + (1));
while(true){
if((i_29154 <= (new_level + (1)))){
(update[i_29154] = self__.header);

var G__29156 = (i_29154 + (1));
i_29154 = G__29156;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29160 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29160[i]));
} else {
x__$2.forward.push((((i < links_29160.length))?(links_29160[i]):null));
}

if((i < links_29160.length)){
(links_29160[i] = x__$2);
} else {
links_29160.push(x__$2);
}
...
var i_29171 = (0);
while(true){
if((i_29171 <= self__.level)){
var links_29173 = (update[i_29171]).forward;
if((x__$1 === (((i_29171 < links_29173.length))?(links_29173[i_29171]):null))){
(links_29173[i_29171] = (x__$1.forward[i_29171]));

var G__29176 = (i_29171 + (1));
i_29171 = G__29176;
continue;
} else {
var G__29177 = (i_29171 + (1));
i_29171 = G__29177;
continue;
}
} else {
...
var G__29187 = nx;
var G__29188 = (level__$1 - (1));
x = G__29187;
level__$1 = G__29188;
continue;
} else {
var G__29195 = x;
var G__29196 = (level__$1 - (1));
x = G__29195;
level__$1 = G__29196;
continue;
}
