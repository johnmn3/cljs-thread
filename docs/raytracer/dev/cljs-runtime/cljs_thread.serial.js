...
return clojure.walk.postwalk((function (p1__20017_SHARP_){
if(cljs.core.truth_(cljs_thread.serial.ct_marker_QMARK_(p1__20017_SHARP_))){
return get_transfer(new cljs.core.Keyword(null,"ctag","ctag",304756589).cljs$core$IFn$_invoke$arity$1(p1__20017_SHARP_));
} else {
if(cljs.core.truth_((function (){var and__5043__auto__ = typeof p1__20017_SHARP_ === 'string';
if(and__5043__auto__){
return p1__20017_SHARP_.startsWith("#cljs-thread/arg-fn");
} else {
return and__5043__auto__;
}
})())){
return eval(["(function () {return (",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(p1__20017_SHARP_,(20)),");})();"].join(''));
} else {
