...
var srcs = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__20367_SHARP_){
return p1__20367_SHARP_.src;
}),scripts);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__20369_SHARP_){
var temp__5823__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(by_id,p1__20369_SHARP_);
if(cljs.core.truth_(temp__5823__auto__)){
var dep_mod = temp__5823__auto__;
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20369_SHARP_,new cljs.core.Keyword(null,"screen","screen",1990059748))){
...
var urls = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__20373_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(base_url),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__20373_SHARP_)].join('');
}),chain);
...
var urls = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__20374_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(base_url),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__20374_SHARP_)].join('');
}),chain);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"kernel-urls","kernel-urls",162437080),urls,new cljs.core.Keyword(null,"screen-name","screen-name",31129652),(cljs.core.truth_(screen_mod)?new cljs.core.Keyword(null,"output-name","output-name",-1769107767).cljs$core$IFn$_invoke$arity$1(screen_mod):null)], null);
} else {
...
if((((typeof document !== 'undefined')) && ((typeof document !== 'undefined') && (typeof document.querySelectorAll !== 'undefined')))){
var scripts = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(document.querySelectorAll("script[src]"));
var srcs = cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__20382_SHARP_){
return p1__20382_SHARP_.src;
}),scripts));
...
var map__20387 = detected;
var map__20387__$1 = cljs.core.__destructure_map(map__20387);
var kernel_urls = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20387__$1,new cljs.core.Keyword(null,"kernel-urls","kernel-urls",162437080));
var screen_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20387__$1,new cljs.core.Keyword(null,"screen-name","screen-name",31129652));
...
if(cljs_thread.platform.node_QMARK_){
try{var fs_20686 = require('fs');
var self_path_20687 = (function (){try{return __filename;
}catch (e20407){var _ = e20407;
return null;
}})();
if(((typeof self_path_20687 === 'string') && (cljs.core.seq(self_path_20687)))){
cljs.core.reset_BANG_(cljs_thread.strategy.fat_kernel.kernel_source,cljs_thread.strategy.fat_kernel.strip_shebang(fs_20686.readFileSync(self_path_20687,"utf8")));
} else {
}
}catch (e20405){var __20689 = e20405;
}
if(cljs.core.truth_(cljs.core.deref(cljs_thread.strategy.fat_kernel.kernel_source))){
return null;
} else {
...
return clojure.walk.postwalk((function (p1__20422_SHARP_){
if((((!((p1__20422_SHARP_ == null)))) && ((((!(typeof p1__20422_SHARP_ === 'string'))) && ((((!(typeof p1__20422_SHARP_ === 'number'))) && ((((!((p1__20422_SHARP_ instanceof cljs.core.Keyword)))) && ((((!(cljs.core.boolean_QMARK_(p1__20422_SHARP_)))) && ((((!(((p1__20422_SHARP_["shared-atom-id"]) == null)))) && ((!(((p1__20422_SHARP_["header-descriptor-idx"]) == null)))))))))))))))){
return ["#cljs-thread/eve-shared-atom {:id ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((p1__20422_SHARP_["shared-atom-id"]))," :idx ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((p1__20422_SHARP_["header-descriptor-idx"])),"}"].join('');
} else {
if((((!((p1__20422_SHARP_ == null)))) && ((((!(typeof p1__20422_SHARP_ === 'string'))) && ((((!(typeof p1__20422_SHARP_ === 'number'))) && ((((!((p1__20422_SHARP_ instanceof cljs.core.Keyword)))) && ((((!(cljs.core.boolean_QMARK_(p1__20422_SHARP_)))) && ((!(((p1__20422_SHARP_["s-atom-env"]) == null)))))))))))))){
...
if(cljs.core.truth_(and__5043__auto__)){
var G__20456 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(data__$1);
var fexpr__20455 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"screen","screen",1990059748),null,new cljs.core.Keyword(null,"root","root",-448657453),null], null), null);
return (fexpr__20455.cljs$core$IFn$_invoke$arity$1 ? fexpr__20455.cljs$core$IFn$_invoke$arity$1(G__20456) : fexpr__20455.call(null, G__20456));
} else {
return and__5043__auto__;
}
})())?"":null);
...
var worker_data = (function (){var G__20461 = data__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20461,new cljs.core.Keyword(null,"__kernel_source","__kernel_source",1368218006),cljs.core.deref(cljs_thread.strategy.fat_kernel.kernel_source));
} else {
return G__20461;
}
})();
...
var source_export = (cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.deref(cljs_thread.strategy.fat_kernel.propagate_source_QMARK_);
if(cljs.core.truth_(and__5043__auto__)){
var G__20475 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(data);
var fexpr__20474 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"root","root",-448657453),null], null), null);
return (fexpr__20474.cljs$core$IFn$_invoke$arity$1 ? fexpr__20474.cljs$core$IFn$_invoke$arity$1(G__20475) : fexpr__20474.call(null, G__20475));
} else {
return and__5043__auto__;
}
...
var boot_msg_20702 = ({"__cljs_thread_boot": true, "__kernel_url": kernel_blob_url, "__origin": (function (){var or__5045__auto__ = cljs.core.deref(cljs_thread.strategy.fat_kernel.kernel_origin);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return "";
...
var temp__5823__auto___20703 = cljs.core.deref(cljs_thread.state.eve_sab_config);
if(cljs.core.truth_(temp__5823__auto___20703)){
var eve_config_20704 = temp__5823__auto___20703;
(boot_msg_20702["__eve_sab_config"] = ({"sab": new cljs.core.Keyword(null,"sab","sab",422570093).cljs$core$IFn$_invoke$arity$1(eve_config_20704), "reader-map-sab": new cljs.core.Keyword(null,"reader-map-sab","reader-map-sab",490876178).cljs$core$IFn$_invoke$arity$1(eve_config_20704), "slab-sabs": new cljs.core.Keyword(null,"slab-sabs","slab-sabs",238684008).cljs$core$IFn$_invoke$arity$1(eve_config_20704), "root-sab": new cljs.core.Keyword(null,"root-sab","root-sab",-932837436).cljs$core$IFn$_invoke$arity$1(eve_config_20704)}));
} else {
}

w.postMessage(boot_msg_20702);
...
var len__5769__auto___20712 = arguments.length;
var i__5770__auto___20714 = (0);
while(true){
if((i__5770__auto___20714 < len__5769__auto___20712)){
args__5775__auto__.push((arguments[i__5770__auto___20714]));

var G__20716 = (i__5770__auto___20714 + (1));
i__5770__auto___20714 = G__20716;
continue;
} else {
}
break;
...
(cljs_thread.strategy.fat_kernel.install_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__20526){
var vec__20527 = p__20526;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20527,(0),null);
var map__20530_20717 = opts;
var map__20530_20718__$1 = cljs.core.__destructure_map(map__20530_20717);
var kernel_source_str_20719 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20530_20718__$1,new cljs.core.Keyword(null,"kernel-source-str","kernel-source-str",-747619305));
var scripts_20721 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20530_20718__$1,new cljs.core.Keyword(null,"scripts","scripts",626373193));
var base_url_20722 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20530_20718__$1,new cljs.core.Keyword(null,"base-url","base-url",9540398));
var loadable_modules_20723 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20530_20718__$1,new cljs.core.Keyword(null,"loadable-modules","loadable-modules",-582233975));
var propagate_20724 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20530_20718__$1,new cljs.core.Keyword(null,"propagate","propagate",274376905));
if(cljs.core.truth_(kernel_source_str_20719)){
cljs.core.reset_BANG_(cljs_thread.strategy.fat_kernel.kernel_source,cljs_thread.strategy.fat_kernel.strip_shebang(kernel_source_str_20719));
} else {
}

if(((cljs.core.not(kernel_source_str_20719)) && (cljs.core.seq(scripts_20721)))){
var urls_20725 = (cljs.core.truth_(base_url_20722)?((cljs_thread.platform.node_QMARK_)?cljs_thread.strategy.common.resolve_node_paths(base_url_20722,scripts_20721):cljs_thread.strategy.common.resolve_script_urls(base_url_20722,scripts_20721)):scripts_20721);
var sources_20726 = ((cljs_thread.platform.node_QMARK_)?(function (){var fs = require('fs');
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__20500_SHARP_){
return fs.readFileSync(p1__20500_SHARP_,"utf8");
}),urls_20725);
})():cljs.core.keep.cljs$core$IFn$_invoke$arity$2(cljs_thread.strategy.fat_kernel.fetch_text_sync,urls_20725));
var combined_20727 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,sources_20726);
if(cljs.core.seq(combined_20727)){
cljs.core.reset_BANG_(cljs_thread.strategy.fat_kernel.kernel_source,combined_20727);

cljs.core.reset_BANG_(cljs_thread.strategy.fat_kernel.kernel_origin,(function (){var or__5045__auto__ = ((cljs.core.seq(urls_20725))?cljs_thread.strategy.common.detect_base_url(cljs.core.first(urls_20725)):null);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return base_url_20722;
}
})());
} else {
}
...
if(((cljs.core.not(kernel_source_str_20719)) && (cljs.core.not(cljs.core.seq(scripts_20721))))){
cljs_thread.strategy.fat_kernel.extract_kernel_source_BANG_();
} else {
}

if(cljs.core.truth_(loadable_modules_20723)){
cljs.core.reset_BANG_(cljs_thread.strategy.fat_kernel.loadable_modules_config,loadable_modules_20723);
} else {
}

cljs.core.reset_BANG_(cljs_thread.strategy.fat_kernel.propagate_source_QMARK_,(((!((propagate_20724 == null))))?propagate_20724:true));
...
/** @this {Function} */
(cljs_thread.strategy.fat_kernel.install_BANG_.cljs$lang$applyTo = (function (seq20513){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq20513));
}));
