...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26727 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26727(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26734 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26734(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26746 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26746(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26752 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26752(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26762 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26762(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26773 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26773(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26792 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26792(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26814 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26814(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26821 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26821(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26839 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26839(b);
}
});
