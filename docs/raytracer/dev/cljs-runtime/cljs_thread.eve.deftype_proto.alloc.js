...
var temp__5823__auto__ = (function (){var G__20201 = s_atom_env;
if((G__20201 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"sab","sab",422570093).cljs$core$IFn$_invoke$arity$1(G__20201);
}
})();
...
var temp__5823__auto___20467 = cljs_thread.eve.shared_atom._STAR_global_atom_instance_STAR_;
if(cljs.core.truth_(temp__5823__auto___20467)){
var inst_20468 = temp__5823__auto___20467;
cljs_thread.eve.deftype_proto.alloc.register_legacy_env_BANG_(cljs_thread.eve.shared_atom.get_env(inst_20468));
} else {
}
}
...
var len__5769__auto___20471 = arguments.length;
var i__5770__auto___20472 = (0);
while(true){
if((i__5770__auto___20472 < len__5769__auto___20471)){
args__5775__auto__.push((arguments[i__5770__auto___20472]));

var G__20473 = (i__5770__auto___20472 + (1));
i__5770__auto___20472 = G__20473;
continue;
} else {
}
break;
...
(cljs_thread.eve.deftype_proto.alloc.init_slab_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (class_idx,p__20207){
var map__20208 = p__20207;
var map__20208__$1 = cljs.core.__destructure_map(map__20208);
var capacity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20208__$1,new cljs.core.Keyword(null,"capacity","capacity",72689734));
...
var map__20209 = layout;
var map__20209__$1 = cljs.core.__destructure_map(map__20209);
var total_bytes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20209__$1,new cljs.core.Keyword(null,"total-bytes","total-bytes",1693967112));
var bitmap_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20209__$1,new cljs.core.Keyword(null,"bitmap-offset","bitmap-offset",-54089933));
var bitmap_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20209__$1,new cljs.core.Keyword(null,"bitmap-size","bitmap-size",-730951825));
var data_offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20209__$1,new cljs.core.Keyword(null,"data-offset","data-offset",-712338495));
var total_blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20209__$1,new cljs.core.Keyword(null,"total-blocks","total-blocks",-168639763));
...
/** @this {Function} */
(cljs_thread.eve.deftype_proto.alloc.init_slab_BANG_.cljs$lang$applyTo = (function (seq20204){
var G__20205 = cljs.core.first(seq20204);
var seq20204__$1 = cljs.core.next(seq20204);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20205,seq20204__$1);
}));
...
(cljs_thread.eve.deftype_proto.alloc.init_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__20221){
var map__20226 = p__20221;
var map__20226__$1 = cljs.core.__destructure_map(map__20226);
var capacities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20226__$1,new cljs.core.Keyword(null,"capacities","capacities",-1666536173),cljs.core.PersistentArrayMap.EMPTY);
var slab_promises = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function cljs_thread$eve$deftype_proto$alloc$iter__20236(s__20237){
return (new cljs.core.LazySeq(null,(function (){
var s__20237__$1 = s__20237;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__20237__$1);
if(temp__5823__auto__){
var s__20237__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20237__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__20237__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__20241 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__20240 = (0);
while(true){
if((i__20240 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__20240);
cljs.core.chunk_append(b__20241,(function (){var cap = cljs.core.get.cljs$core$IFn$_invoke$arity$3(capacities,i,cljs_thread.eve.deftype_proto.data.default_capacity_for_class(i));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20241),cljs_thread$eve$deftype_proto$alloc$iter__20236(cljs.core.chunk_rest(s__20237__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20241),null);
}
} else {
var i = cljs.core.first(s__20237__$2);
...
return cljs_thread.eve.deftype_proto.alloc.init_slab_BANG_.cljs$core$IFn$_invoke$arity$variadic(i,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"capacity","capacity",72689734),cap], 0));
})(),cljs_thread$eve$deftype_proto$alloc$iter__20236(cljs.core.rest(s__20237__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(cljs_thread.eve.deftype_proto.alloc.init_BANG_.cljs$lang$applyTo = (function (seq20218){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq20218));
}));
...
var n__5636__auto___20525 = (256);
var slot_idx_20526 = (0);
while(true){
if((slot_idx_20526 < n__5636__auto___20525)){
var slot_byte_offset_20528 = (cljs_thread.eve.deftype_proto.data.ROOT_WORKER_REGISTRY_START + (slot_idx_20526 * (24)));
Atomics.store(i32,(slot_byte_offset_20528 / (4)),(0));

var G__20529 = (slot_idx_20526 + (1));
slot_idx_20526 = G__20529;
continue;
} else {
}
break;
...
var sabs = [];
var n__5636__auto___20564 = (6);
var i_20565 = (0);
while(true){
if((i_20565 < n__5636__auto___20564)){
sabs.push(cljs_thread.eve.deftype_proto.wasm.slab_buffer(i_20565));
...
var n__5636__auto___20571 = (6);
var i_20572 = (0);
while(true){
if((i_20572 < n__5636__auto___20571)){
var sab_20574 = ((cljs.core.array_QMARK_(slab_sabs))?(slab_sabs[i_20572]):cljs.core.nth.cljs$core$IFn$_invoke$arity$2(slab_sabs,i_20572));
cljs_thread.eve.deftype_proto.wasm.register_slab_instance_from_sab_BANG_(i_20572,sab_20574);

cljs_thread.eve.deftype_proto.alloc.populate_slab_caches_from_header_BANG_(i_20572,sab_20574);

var G__20576 = (i_20572 + (1));
i_20572 = G__20576;
continue;
} else {
}
...
var G__20594 = (candidate + (1));
var G__20595 = wrapped_QMARK_;
start_bit = G__20594;
wrapped_QMARK_ = G__20595;
continue;
}
} else {
...
var cursor = Atomics.load(i32_view,((16) / (4)));
var results = [];
var start_bit_20609 = cursor;
var wrapped_QMARK__20610 = false;
while(true){
if((results.length < max_count)){
var candidate_20611 = cljs_thread.eve.deftype_proto.wasm.bitmap_find_free(class_idx,bm_offset,total_bits,start_bit_20609);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(candidate_20611,(-1))){
if(cljs_thread.eve.deftype_proto.wasm.bitmap_alloc_cas_BANG_(class_idx,bm_offset,candidate_20611)){
results.push(cljs_thread.eve.deftype_proto.alloc.encode_slab_offset(class_idx,candidate_20611));

var G__20612 = (candidate_20611 + (1));
var G__20613 = wrapped_QMARK__20610;
start_bit_20609 = G__20612;
wrapped_QMARK__20610 = G__20613;
continue;
} else {
var G__20614 = (candidate_20611 + (1));
var G__20615 = wrapped_QMARK__20610;
start_bit_20609 = G__20614;
wrapped_QMARK__20610 = G__20615;
continue;
}
} else {
if(((cljs.core.not(wrapped_QMARK__20610)) && ((cursor > (0))))){
var G__20617 = (0);
var G__20618 = true;
start_bit_20609 = G__20617;
wrapped_QMARK__20610 = G__20618;
continue;
} else {
...
if((results.length > (0))){
var last_offset_20619 = (results[(results.length - (1))]);
var last_block_20620 = cljs_thread.eve.deftype_proto.alloc.decode_block_idx(last_offset_20619);
Atomics.store(i32_view,((16) / (4)),cljs.core.mod((last_block_20620 + (1)),total_bits));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function cljs_thread$eve$deftype_proto$alloc$all_slab_stats_$_iter__20441(s__20442){
return (new cljs.core.LazySeq(null,(function (){
var s__20442__$1 = s__20442;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__20442__$1);
if(temp__5823__auto__){
var s__20442__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20442__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__20442__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__20444 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__20443 = (0);
while(true){
if((i__20443 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__20443);
cljs.core.chunk_append(b__20444,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,cljs_thread.eve.deftype_proto.alloc.slab_stats(i)], null));

var G__20758 = (i__20443 + (1));
i__20443 = G__20758;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20444),cljs_thread$eve$deftype_proto$alloc$all_slab_stats_$_iter__20441(cljs.core.chunk_rest(s__20442__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20444),null);
}
} else {
var i = cljs.core.first(s__20442__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,cljs_thread.eve.deftype_proto.alloc.slab_stats(i)], null),cljs_thread$eve$deftype_proto$alloc$all_slab_stats_$_iter__20441(cljs.core.rest(s__20442__$2)));
}
} else {
return null;
}
