...
var temp__5823__auto___20857 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs_thread.dom.registry.handle__GT_obj),handle);
if(cljs.core.truth_(temp__5823__auto___20857)){
var obj_20858 = temp__5823__auto___20857;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(cljs_thread.dom.registry.handle__GT_obj,cljs.core.dissoc,handle);

cljs_thread.dom.registry.obj__GT_handle.delete(obj_20858);
} else {
}
...
var arr = [];
var n__5636__auto___20859 = result.length;
var i_20860 = (0);
while(true){
if((i_20860 < n__5636__auto___20859)){
arr.push((function (){var G__20720 = result.item(i_20860);
return (cljs_thread.dom.registry.result__GT_wire.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.dom.registry.result__GT_wire.cljs$core$IFn$_invoke$arity$1(G__20720) : cljs_thread.dom.registry.result__GT_wire.call(null, G__20720));
})());

var G__20862 = (i_20860 + (1));
i_20860 = G__20862;
continue;
} else {
}
...
var G__20749 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),event.type], null);
var G__20749__$1 = (cljs.core.truth_(target)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20749,new cljs.core.Keyword(null,"target","target",253001721),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handle","handle",1538948854),cljs_thread.dom.registry.register_BANG_(target),new cljs.core.Keyword(null,"type","type",1174270348),(function (){var or__5045__auto__ = target.nodeName;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return "EventTarget";
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20749__$1,new cljs.core.Keyword(null,"current-target","current-target",34322910),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handle","handle",1538948854),cljs_thread.dom.registry.register_BANG_(current_target),new cljs.core.Keyword(null,"type","type",1174270348),(function (){var or__5045__auto__ = current_target.nodeName;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return "EventTarget";
