...
var page_scripts = cljs.core.filterv((function (p1__21208_SHARP_){
return ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21208_SHARP_,core_name)) && (((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21208_SHARP_,sw_name)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21208_SHARP_,"")))));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21207_SHARP_){
return basename(p1__21207_SHARP_.src);
...
var temp__5823__auto___21237 = cljs_thread.strategy.fat_kernel.detect_core_connect_string();
if(cljs.core.truth_(temp__5823__auto___21237)){
var detected_21238 = temp__5823__auto___21237;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_thread.state.conf,cljs.core.assoc,new cljs.core.Keyword(null,"core-connect-string","core-connect-string",-1385565583),detected_21238);
} else {
}
}
...
var temp__5823__auto___21239 = cljs_thread.core.auto_detect_loadable_modules(cljs.core.deref(cljs_thread.state.conf));
if(cljs.core.truth_(temp__5823__auto___21239)){
var modules_21240 = temp__5823__auto___21239;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_thread.state.conf,cljs.core.assoc,new cljs.core.Keyword(null,"loadable-modules","loadable-modules",-582233975),modules_21240);
} else {
}
}
...
cljs_thread.msg.dispatch.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Keyword(null,"in-result","in-result",13280282),(function (p__21211){
var map__21212 = p__21211;
var map__21212__$1 = cljs.core.__destructure_map(map__21212);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21212__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var map__21213 = data;
var map__21213__$1 = cljs.core.__destructure_map(map__21213);
var in_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21213__$1,new cljs.core.Keyword(null,"in-id","in-id",2013544614));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21213__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var temp__5823__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs_thread.state.requests),in_id);
if(cljs.core.truth_(temp__5823__auto__)){
var map__21214 = temp__5823__auto__;
var map__21214__$1 = cljs.core.__destructure_map(map__21214);
var resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21214__$1,new cljs.core.Keyword(null,"resolve","resolve",-1584445482));
...
if(cljs.core.truth_(and__5043__auto__)){
return (((call_result_21242 instanceof Promise)) && (cljs.core.not(new cljs.core.Keyword(null,"deamon?","deamon?",-1569034262).cljs$core$IFn$_invoke$arity$1(cljs_thread.env.data))));
} else {
return and__5043__auto__;
}
})())){
call_result_21242.then((function (_){
...
if(cljs.core.truth_(cljs_thread.env.in_screen_QMARK_())){
var G__21216_21245 = (function (_header_descriptor_idx){
var seq__21217 = cljs.core.seq(cljs.core.deref(cljs_thread.state.peers));
var chunk__21218 = null;
var count__21219 = (0);
var i__21220 = (0);
while(true){
if((i__21220 < count__21219)){
var vec__21229 = chunk__21218.cljs$core$IIndexed$_nth$arity$2(null, i__21220);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21229,(0),null);
var _peer = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21229,(1),null);
...
try{cljs_thread.in$.do_in.cljs$core$IFn$_invoke$arity$variadic(id,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentVector.EMPTY,cljs.core.str.cljs$core$IFn$_invoke$arity$1(((function (seq__21217,chunk__21218,count__21219,i__21220,vec__21229,id,_peer){
return (function (){
return (cljs_thread.eve.check_remote_watches_BANG_.cljs$core$IFn$_invoke$arity$0 ? cljs_thread.eve.check_remote_watches_BANG_.cljs$core$IFn$_invoke$arity$0() : cljs_thread.eve.check_remote_watches_BANG_.call(null, ));
});})(seq__21217,chunk__21218,count__21219,i__21220,vec__21229,id,_peer))
),cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"yield?","yield?",-2100785447),null,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"go?","go?",966681578),false], 0))], 0));
}catch (e21232){var _e_21246 = e21232;
}} else {
}


var G__21247 = seq__21217;
var G__21248 = chunk__21218;
var G__21249 = count__21219;
var G__21250 = (i__21220 + (1));
seq__21217 = G__21247;
chunk__21218 = G__21248;
count__21219 = G__21249;
i__21220 = G__21250;
continue;
} else {
var temp__5823__auto__ = cljs.core.seq(seq__21217);
if(temp__5823__auto__){
var seq__21217__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__21217__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__21217__$1);
var G__21251 = cljs.core.chunk_rest(seq__21217__$1);
var G__21252 = c__5568__auto__;
var G__21253 = cljs.core.count(c__5568__auto__);
var G__21254 = (0);
seq__21217 = G__21251;
chunk__21218 = G__21252;
count__21219 = G__21253;
i__21220 = G__21254;
continue;
} else {
var vec__21233 = cljs.core.first(seq__21217__$1);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21233,(0),null);
var _peer = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21233,(1),null);
if((((id instanceof cljs.core.Keyword)) && (((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"parent","parent",-878878779))) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"screen","screen",1990059748))))))){
try{cljs_thread.in$.do_in.cljs$core$IFn$_invoke$arity$variadic(id,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentVector.EMPTY,cljs.core.str.cljs$core$IFn$_invoke$arity$1(((function (seq__21217,chunk__21218,count__21219,i__21220,vec__21233,id,_peer,seq__21217__$1,temp__5823__auto__){
return (function (){
return (cljs_thread.eve.check_remote_watches_BANG_.cljs$core$IFn$_invoke$arity$0 ? cljs_thread.eve.check_remote_watches_BANG_.cljs$core$IFn$_invoke$arity$0() : cljs_thread.eve.check_remote_watches_BANG_.call(null, ));
});})(seq__21217,chunk__21218,count__21219,i__21220,vec__21233,id,_peer,seq__21217__$1,temp__5823__auto__))
),cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"yield?","yield?",-2100785447),null,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"go?","go?",966681578),false], 0))], 0));
}catch (e21236){var _e_21255 = e21236;
}} else {
}


var G__21256 = cljs.core.next(seq__21217__$1);
var G__21257 = null;
var G__21258 = (0);
var G__21259 = (0);
seq__21217 = G__21256;
chunk__21218 = G__21257;
count__21219 = G__21258;
i__21220 = G__21259;
continue;
}
} else {
...
(cljs_thread.eve.set_broadcast_swap_fn_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.eve.set_broadcast_swap_fn_BANG_.cljs$core$IFn$_invoke$arity$1(G__21216_21245) : cljs_thread.eve.set_broadcast_swap_fn_BANG_.call(null, G__21216_21245));
} else {
}
