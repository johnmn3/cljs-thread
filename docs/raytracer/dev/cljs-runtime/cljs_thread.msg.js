...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__20590 = cljs.core.get_global_hierarchy;
return (fexpr__20590.cljs$core$IFn$_invoke$arity$0 ? fexpr__20590.cljs$core$IFn$_invoke$arity$0() : fexpr__20590.call(null, ));
})());
...
var data__$2 = (function (){var G__20593 = data__$1;
var G__20593__$1 = (cljs.core.truth_(raw_sargs)?cljs.core.assoc_in(G__20593,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"sargs","sargs",1421118304)], null),raw_sargs):G__20593);
var G__20593__$2 = (cljs.core.truth_(raw_transfers)?cljs.core.assoc_in(G__20593__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"transfers","transfers",2123810614)], null),raw_transfers):G__20593__$1);
if(cljs.core.truth_(sync_signal_sab)){
return cljs.core.assoc_in(G__20593__$2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526)], null),sync_signal_sab);
} else {
return G__20593__$2;
}
})();
...
var target_20649 = (cljs.core.truth_(cljs_thread.env.in_screen_QMARK_())?((cljs_thread.platform.node_QMARK_)?null:cljs_thread.platform.self_ref()):cljs_thread.platform.self_ref());
if(cljs.core.truth_(target_20649)){
cljs_thread.platform.listen(target_20649,cljs_thread.msg.message_handler);
} else {
}
...
cljs_thread.msg.dispatch.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Keyword(null,"pprint","pprint",1220198395),(function (p__20595){
var map__20596 = p__20595;
var map__20596__$1 = cljs.core.__destructure_map(map__20596);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20596__$1,new cljs.core.Keyword(null,"data","data",-232669377));
return cljs_thread.msg.do_pprint(data);
}));
cljs_thread.msg.dispatch.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Keyword(null,"receive-port","receive-port",777599529),(function (p__20597){
var map__20598 = p__20597;
var map__20598__$1 = cljs.core.__destructure_map(map__20598);
var map__20599 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20598__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var map__20599__$1 = cljs.core.__destructure_map(map__20599);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20599__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20599__$1,new cljs.core.Keyword(null,"port","port",1534937262));
var sync_channel_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20599__$1,new cljs.core.Keyword(null,"sync-channel-sab","sync-channel-sab",732032425));
var sync_channel_atom_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20599__$1,new cljs.core.Keyword(null,"sync-channel-atom-id","sync-channel-atom-id",-128110154));
var sync_channel_atom_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20599__$1,new cljs.core.Keyword(null,"sync-channel-atom-idx","sync-channel-atom-idx",-1198513701));
...
var response_atom_20650 = cljs_thread.eve.reconstruct_shared_atom(sync_channel_atom_id,sync_channel_atom_idx);
var sync_channel_20651 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271),sync_channel_sab,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196),response_atom_20650], null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_thread.state.peers,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"sync-channel","sync-channel",74563328)], null),sync_channel_20651);
} else {
}
...
var len__5769__auto___20652 = arguments.length;
var i__5770__auto___20653 = (0);
while(true){
if((i__5770__auto___20653 < len__5769__auto___20652)){
args__5775__auto__.push((arguments[i__5770__auto___20653]));

var G__20654 = (i__5770__auto___20653 + (1));
i__5770__auto___20653 = G__20654;
continue;
} else {
}
break;
...
(cljs_thread.msg.when_peer_ready.cljs$core$IFn$_invoke$arity$variadic = (function (id,afn,p__20606){
var vec__20607 = p__20606;
var watch_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20607,(0),null);
...
var G__20610_20655 = ["[when-peer-ready] env:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs_thread.env.data))," id:",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([id], 0))," present:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.boolean$(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs_thread.state.peers),id)))].join('');
(cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1(G__20610_20655) : cljs_thread.msg.debug_log_BANG_.call(null, G__20610_20655));

if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs_thread.state.peers),id))){
var G__20611_20656 = ["[when-peer-ready] executing for ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([id], 0))].join('');
(cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1(G__20611_20656) : cljs_thread.msg.debug_log_BANG_.call(null, G__20611_20656));
...
/** @this {Function} */
(cljs_thread.msg.when_peer_ready.cljs$lang$applyTo = (function (seq20601){
var G__20602 = cljs.core.first(seq20601);
var seq20601__$1 = cljs.core.next(seq20601);
var G__20603 = cljs.core.first(seq20601__$1);
var seq20601__$2 = cljs.core.next(seq20601__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20602,G__20603,seq20601__$2);
}));
...
var data_without_extras = (function (){var G__20613 = data;
var G__20613__$1 = (cljs.core.truth_(sargs)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__20613,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.dissoc,new cljs.core.Keyword(null,"sargs","sargs",1421118304)):G__20613);
var G__20613__$2 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(data,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526)], null)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__20613__$1,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.dissoc,new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526)):G__20613__$1);
var G__20613__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526).cljs$core$IFn$_invoke$arity$1(data))?cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__20613__$2,new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526)):G__20613__$2);
if(cljs.core.truth_(sync_channel)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__20613__$3,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.dissoc,new cljs.core.Keyword(null,"sync-channel","sync-channel",74563328));
} else {
return G__20613__$3;
}
})();
...
var args__5775__auto__ = [];
var len__5769__auto___20659 = arguments.length;
var i__5770__auto___20660 = (0);
while(true){
if((i__5770__auto___20660 < len__5769__auto___20659)){
args__5775__auto__.push((arguments[i__5770__auto___20660]));

var G__20661 = (i__5770__auto___20660 + (1));
i__5770__auto___20660 = G__20661;
continue;
} else {
}
break;
...
(cljs_thread.msg.post.cljs$core$IFn$_invoke$arity$variadic = (function (worker_id,p__20617,p__20618){
var map__20619 = p__20617;
var map__20619__$1 = cljs.core.__destructure_map(map__20619);
var data = map__20619__$1;
var map__20620 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20619__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var map__20620__$1 = cljs.core.__destructure_map(map__20620);
var transfers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20620__$1,new cljs.core.Keyword(null,"transfers","transfers",2123810614));
var vec__20621 = p__20618;
var transferables = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20621,(0),null);
var G__20624_20666 = ["[post] env:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs_thread.env.data))," worker-id:",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([worker_id], 0))," dispatch:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(data))].join('');
(cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1(G__20624_20666) : cljs_thread.msg.debug_log_BANG_.call(null, G__20624_20666));

var transferables__$1 = cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__20625){
var vec__20626 = p__20625;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20626,(0),null);
var map__20629 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20626,(1),null);
var map__20629__$1 = cljs.core.__destructure_map(map__20629);
var transfer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20629__$1,new cljs.core.Keyword(null,"transfer","transfer",327423400));
return transfer;
}),transfers));
...
var G__20632_20672 = ["[post] w:",(cljs.core.truth_(w)?"found":"nil")," id:",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([id], 0))].join('');
(cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1(G__20632_20672) : cljs_thread.msg.debug_log_BANG_.call(null, G__20632_20672));
...
var G__20636_20675 = ["[post] proxying to root for id:",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([id], 0))].join('');
(cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1(G__20636_20675) : cljs_thread.msg.debug_log_BANG_.call(null, G__20636_20675));
...
var proxy_data = (function (){var G__20637 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.Keyword(null,"proxy","proxy",-117453614),new cljs.core.Keyword(null,"data","data",-232669377),data_with_to], null);
if(cljs.core.truth_(inner_sab)){
return cljs.core.assoc_in(G__20637,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"sync-signal-sab","sync-signal-sab",1124899526)], null),inner_sab);
} else {
return G__20637;
}
})();
var G__20638_20681 = ["[post] root-w:",(cljs.core.truth_(root_w)?"found":"nil")].join('');
(cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1(G__20638_20681) : cljs_thread.msg.debug_log_BANG_.call(null, G__20638_20681));
...
var G__20639_20683 = ["[post] delayed proxy to root for id:",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([id], 0))].join('');
(cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.msg.debug_log_BANG_.cljs$core$IFn$_invoke$arity$1(G__20639_20683) : cljs_thread.msg.debug_log_BANG_.call(null, G__20639_20683));
...
/** @this {Function} */
(cljs_thread.msg.post.cljs$lang$applyTo = (function (seq20614){
var G__20615 = cljs.core.first(seq20614);
var seq20614__$1 = cljs.core.next(seq20614);
var G__20616 = cljs.core.first(seq20614__$1);
var seq20614__$2 = cljs.core.next(seq20614__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20615,G__20616,seq20614__$2);
}));

cljs_thread.msg.debug_log_BANG_ = (function cljs_thread$msg$debug_log_BANG_(_msg){
return null;
});
cljs_thread.msg.dispatch.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Keyword(null,"proxy","proxy",-117453614),(function (p__20640){
var map__20641 = p__20640;
var map__20641__$1 = cljs.core.__destructure_map(map__20641);
var outer = map__20641__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20641__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var vec__20646 = cljs_thread.msg.mk_chan_pair();
var c1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20646,(0),null);
var c2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20646,(1),null);
