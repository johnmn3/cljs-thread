...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271),(new SharedArrayBuffer((8))),new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196),(function (){var G__20557 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs_thread.eve.atom.cljs$core$IFn$_invoke$arity$1 ? cljs_thread.eve.atom.cljs$core$IFn$_invoke$arity$1(G__20557) : cljs_thread.eve.atom.call(null, G__20557));
})()], null);
}));
 ...
 */
cljs_thread.sync.deliver_response = (function cljs_thread$sync$deliver_response(p__20558,in_id,result){
var map__20559 = p__20558;
var map__20559__$1 = cljs.core.__destructure_map(map__20559);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20559__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20559__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
...
var map__20560 = sync_channel;
var map__20560__$1 = cljs.core.__destructure_map(map__20560);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20560__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var response_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20560__$1,new cljs.core.Keyword(null,"response-atom","response-atom",-1906696196));
var signal_i32 = (new Int32Array(signal_sab));
 ...
 */
cljs_thread.sync.reset_sync_channel_BANG_ = (function cljs_thread$sync$reset_sync_channel_BANG_(p__20561){
var map__20562 = p__20561;
var map__20562__$1 = cljs.core.__destructure_map(map__20562);
var signal_sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20562__$1,new cljs.core.Keyword(null,"signal-sab","signal-sab",-1535673271));
var signal_i32 = (new Int32Array(signal_sab));
...
var len__5769__auto___20583 = arguments.length;
var i__5770__auto___20584 = (0);
while(true){
if((i__5770__auto___20584 < len__5769__auto___20583)){
args__5775__auto__.push((arguments[i__5770__auto___20584]));

var G__20585 = (i__5770__auto___20584 + (1));
i__5770__auto___20584 = G__20585;
continue;
} else {
}
break;
...
(cljs_thread.sync.request.cljs$core$IFn$_invoke$arity$variadic = (function (getter,p__20565){
var map__20566 = p__20565;
var map__20566__$1 = cljs.core.__destructure_map(map__20566);
var opts = map__20566__$1;
var resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20566__$1,new cljs.core.Keyword(null,"resolve","resolve",-1584445482));
var reject = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20566__$1,new cljs.core.Keyword(null,"reject","reject",1415953113));
var no_park = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20566__$1,new cljs.core.Keyword(null,"no-park","no-park",-2136886220));
var max_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20566__$1,new cljs.core.Keyword(null,"max-time","max-time",857408479));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20566__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
/** @this {Function} */
(cljs_thread.sync.request.cljs$lang$applyTo = (function (seq20563){
var G__20564 = cljs.core.first(seq20563);
var seq20563__$1 = cljs.core.next(seq20563);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20564,seq20563__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___20586 = arguments.length;
var i__5770__auto___20587 = (0);
while(true){
if((i__5770__auto___20587 < len__5769__auto___20586)){
args__5775__auto__.push((arguments[i__5770__auto___20587]));

var G__20588 = (i__5770__auto___20587 + (1));
i__5770__auto___20587 = G__20588;
continue;
} else {
}
break;
...
(cljs_thread.sync.send_response.cljs$core$IFn$_invoke$arity$variadic = (function (payload,p__20569){
var vec__20570 = p__20569;
var _db_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20570,(0),null);
cljs_thread.sync.throw_if_non_blocking();
...
/** @this {Function} */
(cljs_thread.sync.send_response.cljs$lang$applyTo = (function (seq20567){
...
cljs_thread.sync.wrap_derefable = (function cljs_thread$sync$wrap_derefable(p__20575){
var map__20576 = p__20575;
var map__20576__$1 = cljs.core.__destructure_map(map__20576);
var data = map__20576__$1;
var promise_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20576__$1,new cljs.core.Keyword(null,"promise?","promise?",-1924347409));
...
return (new Promise((cljs.core.truth_(no_delay_QMARK_)?(function (p1__20573_SHARP_,p2__20574_SHARP_){
return cljs_thread.sync.request.cljs$core$IFn$_invoke$arity$variadic(id__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"resolve","resolve",-1584445482),p1__20573_SHARP_,new cljs.core.Keyword(null,"reject","reject",1415953113),p2__20574_SHARP_], null)], 0));
}):(function (){
return id__$1;
...
var obj = (function (){var x20578 = cljs.core.clone(p);
(x20578.cljs_thread$id$IDable$ = cljs.core.PROTOCOL_SENTINEL);

(x20578.cljs_thread$id$IDable$get_id$arity$1 = (function (_){
var ___$1 = this;
return id__$1;
}));

(x20578.cljs$core$IPending$ = cljs.core.PROTOCOL_SENTINEL);

(x20578.cljs$core$IPending$_realized_QMARK_$arity$1 = (function (_){
var ___$1 = this;
return cljs.core.deref(resolved_QMARK_);
}));

(x20578.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x20578.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (x,writer,opts){
var x__$1 = this;
...
(x20578.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x20578.cljs$core$IDeref$_deref$arity$1 = (function (_){
var ___$1 = this;
 ...
 */
cljs_thread.sync.wrap_derefable_direct = (function cljs_thread$sync$wrap_derefable_direct(p__20579){
var map__20580 = p__20579;
var map__20580__$1 = cljs.core.__destructure_map(map__20580);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20580__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var sync_channel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20580__$1,new cljs.core.Keyword(null,"sync-channel","sync-channel",74563328));
var resolved_QMARK_ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(false);
var resolved_value = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
var obj = (function (){var x20581 = cljs.core.clone(id);
(x20581.cljs_thread$id$IDable$ = cljs.core.PROTOCOL_SENTINEL);

(x20581.cljs_thread$id$IDable$get_id$arity$1 = (function (_){
var ___$1 = this;
return id;
}));

(x20581.cljs$core$IPending$ = cljs.core.PROTOCOL_SENTINEL);

(x20581.cljs$core$IPending$_realized_QMARK_$arity$1 = (function (_){
var ___$1 = this;
return cljs.core.deref(resolved_QMARK_);
}));

(x20581.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x20581.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (x,writer,opts){
var x__$1 = this;
...
(x20581.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x20581.cljs$core$IDeref$_deref$arity$1 = (function (_){
var ___$1 = this;
