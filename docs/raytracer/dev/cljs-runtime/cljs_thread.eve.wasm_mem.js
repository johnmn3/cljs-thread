...
var buffer_22104 = memory.buffer;
cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_u8,(new Uint8Array(buffer_22104)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_i32,(new Int32Array(buffer_22104)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_f64,(new Float64Array(buffer_22104)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_dv,(new DataView(buffer_22104)));
...
var buffer_22110 = memory.buffer;
cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_u8,(new Uint8Array(buffer_22110)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_i32,(new Int32Array(buffer_22110)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_f64,(new Float64Array(buffer_22110)));

cljs.core.reset_BANG_(cljs_thread.eve.wasm_mem.mem_dv,(new DataView(buffer_22110)));
...
var G__22132 = (i + (1));
var G__22133 = cljs.core.imul((hash ^ (u8[(offset + i)])),(16777619));
i = G__22132;
hash = G__22133;
continue;
}
