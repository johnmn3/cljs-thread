...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19983)].join('')));
...
var G__19984 = kw;
var G__19984__$1 = (((G__19984 instanceof cljs.core.Keyword))?G__19984.fqn:null);
switch (G__19984__$1) {
case "uint8":
return (1);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19985)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19986)].join('')));
...
var self__ = this;
var this$ = this;
return ["#eve/array ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs_thread.eve.array.subtype__GT_type_kw(self__.subtype_code))," [",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.take.cljs$core$IFn$_invoke$arity$2((10),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19987_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(this$,p1__19987_SHARP_);
...
var i_20481 = (0);
while(true){
if((i_20481 < (function (){var x__5133__auto__ = (20);
var y__5134__auto__ = self__.length;
return ((x__5133__auto__ < y__5134__auto__) ? x__5133__auto__ : y__5134__auto__);
})())){
if((i_20481 > (0))){
...
cljs.core._write(writer,cljs.core.str.cljs$core$IFn$_invoke$arity$1(this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i_20481)));

var G__20487 = (i_20481 + (1));
i_20481 = G__20487;
continue;
} else {
}
...
if((i < self__.length)){
var G__20493 = (i + (1));
var G__20494 = (((31) * h) + cljs.core.hash(this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i)));
i = G__20493;
h = G__20494;
continue;
} else {
...
while(true){
if((i < self__.length)){
var result = (function (){var G__20018 = acc;
var G__20019 = this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i);
...
while(true){
if((i < self__.length)){
var result = (function (){var G__20020 = acc;
var G__20021 = this$__$1.cljs$core$IIndexed$_nth$arity$2(null, i);
...
var this$__$1 = this;
if((self__.length > (0))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19988_SHARP_){
return this$__$1.cljs$core$IIndexed$_nth$arity$2(null, p1__19988_SHARP_);
...
var self__ = this;
var self__ = this;
var G__20022 = (arguments.length - (1));
switch (G__20022) {
case (1):
...
(cljs_thread.eve.array.EveArray.prototype.apply = (function (self__,args20016){
var self__ = this;
var self____$1 = this;
...
var map__20028 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__20028__$1 = cljs.core.__destructure_map(map__20028);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20028__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20028__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20028__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20028__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
...
if(atomic){
var n__5636__auto___20507 = n;
var i_20508 = (0);
while(true){
if((i_20508 < n__5636__auto___20507)){
Atomics.store(view,(base_idx + i_20508),fill_val);

var G__20509 = (i_20508 + (1));
i_20508 = G__20509;
continue;
} else {
}
...
var n__5636__auto___20510 = n;
var i_20511 = (0);
while(true){
if((i_20511 < n__5636__auto___20510)){
(view[(base_idx + i_20511)] = fill_val);

var G__20512 = (i_20511 + (1));
i_20511 = G__20512;
continue;
} else {
}
...
var subtype = cljs_thread.eve.array.type_kw__GT_subtype(type_kw);
var map__20033 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__20033__$1 = cljs.core.__destructure_map(map__20033);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20033__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20033__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20033__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20033__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
var elem_shift = cljs_thread.eve.array.subtype__GT_elem_shift(subtype);
var atomic = cljs_thread.eve.array.subtype__GT_atomic_QMARK_(subtype);
var view = cljs_thread.eve.array.make_typed_view(sab,subtype);
var arr = (new cljs_thread.eve.array.EveArray(sab,block_start,offset,n,descriptor_idx,subtype,elem_shift,atomic,view,null,null));
var base_idx = (offset >>> elem_shift);
if(atomic){
var n__5636__auto___20513 = n;
var i_20514 = (0);
while(true){
if((i_20514 < n__5636__auto___20513)){
Atomics.store(view,(base_idx + i_20514),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(v,i_20514));

var G__20515 = (i_20514 + (1));
i_20514 = G__20515;
continue;
} else {
}
...
var n__5636__auto___20516 = n;
var i_20517 = (0);
while(true){
if((i_20517 < n__5636__auto___20516)){
(view[(base_idx + i_20517)] = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(v,i_20517));
...
var view_20524 = arr.typed_view;
var base_20525 = (arr.offset >>> arr.elem_shift);
if(cljs.core.truth_(arr.atomic_QMARK_)){
Atomics.store(view_20524,(base_20525 + idx),val);
} else {
(view_20524[(base_20525 + idx)] = val);
}
...
var v = result.value;
return Promise.resolve((function (){var G__20136 = v;
switch (G__20136) {
case "ok":
return new cljs.core.Keyword(null,"ok","ok",967785236);
...
while(true){
if((i < len)){
var result = (function (){var G__20145 = acc;
var G__20146 = i;
var G__20147 = cljs_thread.eve.array.aget(arr,i);
...
var n__5636__auto___20535 = len;
var i_20536 = (0);
while(true){
if((i_20536 < n__5636__auto___20535)){
cljs_thread.eve.array.aset_BANG_(result,i_20536,(function (){var G__20148 = i_20536;
var G__20149 = cljs_thread.eve.array.aget(arr,i_20536);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__20148,G__20149) : f.call(null, G__20148,G__20149));
})());
...
var len = arr.length;
var n__5636__auto___20538 = len;
var i_20539 = (0);
while(true){
if((i_20539 < n__5636__auto___20538)){
cljs_thread.eve.array.aset_BANG_(arr,i_20539,(function (){var G__20150 = i_20539;
var G__20151 = cljs_thread.eve.array.aget(arr,i_20539);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__20150,G__20151) : f.call(null, G__20150,G__20151));
})());

var G__20540 = (i_20539 + (1));
i_20539 = G__20540;
continue;
} else {
}
...
while(true){
if((i_20542 < end__$1)){
cljs_thread.eve.array.aset_BANG_(arr,i_20542,val);

var G__20543 = (i_20542 + (1));
i_20542 = G__20543;
continue;
} else {
}
...
var n__5636__auto___20545 = len;
var i_20546 = (0);
while(true){
if((i_20546 < n__5636__auto___20545)){
cljs_thread.eve.array.aset_BANG_(dest,(dest_start + i_20546),cljs_thread.eve.array.aget(src,(src_start + i_20546)));
...
var dest_byte_offset_20550 = (dest.offset + (dest_start * (4)));
var src_byte_offset_20551 = (src.offset + (src_start * (4)));
cljs_thread.eve.wasm_mem.simd_copy_i32_BANG_(dest_byte_offset_20550,src_byte_offset_20551,len);
} else {
}
...
var n = elem.length;
var map__20300 = cljs_thread.eve.array.alloc_eve_region(subtype,n);
var map__20300__$1 = cljs.core.__destructure_map(map__20300);
var sab = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20300__$1,new cljs.core.Keyword(null,"sab","sab",422570093));
var block_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20300__$1,new cljs.core.Keyword(null,"block-start","block-start",-333036359));
var offset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20300__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var descriptor_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20300__$1,new cljs.core.Keyword(null,"descriptor-idx","descriptor-idx",-1394352825));
var elem_shift = cljs_thread.eve.array.subtype__GT_elem_shift(subtype);
var atomic = cljs_thread.eve.array.subtype__GT_atomic_QMARK_(subtype);
var view = cljs_thread.eve.array.make_typed_view(sab,subtype);
var base_idx = (offset >>> elem_shift);
